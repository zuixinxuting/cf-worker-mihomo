...
$&`).replace(/(?:^|\n)([\t ].*)(?:([\n\t ]*)\n(?![\n\t ]))?/g,"$1$2").replace(/\n+/g,`$&${c}`),N=!1,L=ut(n,!0);r!=="folded"&&e!==y.BLOCK_FOLDED&&(L.onOverflow=()=>{N=!0});let b=Ue(`${S}${x}${m}`,c,ct,L);if(!N)return`>${A}
