...
`+C:b.comment=C,N.comment=N.comment.substring(C.length+1)}}if(!r&&!A&&!N.found){let C=x?s(t,x,N,i):e(t,N.end,A,null,N,i);c.items.push(C),f=C.range[2],ls(x)&&i(C.range,"BLOCK_IN_FLOW",as)}else{t.atKey=!0;let C=N.end,b=k?s(t,k,N,i):e(t,C,S,null,N,i);ls(k)&&i(b.range,"BLOCK_IN_FLOW",as),t.atKey=!1;let I=ie(A??[],{flow:a,indicator:"map-value-ind",next:x,offset:b.range[2],onError:i,parentIndent:n.indent,startOnNewline:!1});if(I.found){if(!r&&!N.found&&t.options.strict){if(A)for(let M of A){if(M===I.found)break;if(M.type==="newline"){i(M,"MULTILINE_IMPLICIT_KEY","Implicit keys of flow sequence pairs need to be on a single line");break}}N.start<I.found.offset-1024&&i(I.found,"KEY_OVER_1024_CHARS","The : indicator must be at most 1024 chars after the start of an implicit flow sequence key")}}else x&&("source"in x&&x.source&&x.source[0]===":"?i(x,"MISSING_CHAR",`Missing space after : in ${a}`):i(I.start,"MISSING_CHAR",`Missing , or : between ${a} items`));let fe=x?s(t,x,I,i):I.found?e(t,I.end,A,null,I,i):null;fe?ls(x)&&i(fe.range,"BLOCK_IN_FLOW",as):I.comment&&(b.comment?b.comment+=`
`+I.comment:b.comment=I.comment);let ke=new L(b,fe);if(t.options.keepSourceTokens&&(ke.srcToken=w),r){let M=c;It(t,M.items,b)&&i(C,"DUPLICATE_KEY","Map keys must be unique"),M.items.push(ke)}else{let M=new T(t.schema);M.flow=!0,M.items.push(ke);let As=(fe??b).range;M.range=[b.range[0],As[1],As[2]],c.items.push(M)}f=fe?fe.range[2]:I.end}}let u=r?"}":"]",[m,...g]=n.end,p=f;if(m&&m.source===u)p=m.offset+m.source.length;else{let h=a[0].toUpperCase()+a.substring(1),w=d?`${h} must end with a ${u}`:`${h} in block collection must be sufficiently indented and end with a ${u}`;i(f,d?"MISSING_CHAR":"BAD_INDENT",w),m&&m.source.length!==1&&g.unshift(m)}if(g.length>0){let h=oe(g,p,t.options.strict,i);h.comment&&(c.comment?c.comment+=`
`+h.comment:c.comment=h.comment),c.range=[n.offset,p,h.offset]}else c.range=[n.offset,p,p];return c}function cs(s,e,t,n,i,o){let r=t.type==="block-map"?Qs(s,e,t,n,o):t.type==="block-seq"?Xs(s,e,t,n,o):Zs(s,e,t,n,o),a=r.constructor;return i==="!"||i===a.tagName?(r.tag=a.tagName,r):(i&&(r.tag=i),r)}function en(s,e,t,n,i){let o=n.tag,r=o?e.directives.tagName(o.source,u=>i(o,"TAG_RESOLVE_FAILED",u)):null;if(t.type==="block-seq"){let{anchor:u,newlineAfterProp:m}=n,g=u&&o?u.offset>o.offset?u:o:u??o;g&&(!m||m.offset<g.offset)&&i(g,"MISSING_CHAR","Missing newline after block sequence props")}let a=t.type==="block-map"?"map":t.type==="block-seq"?"seq":t.start.source==="{"?"map":"seq";if(!o||!r||r==="!"||r===T.tagName&&a==="map"||r===P.tagName&&a==="seq")return cs(s,e,t,i,r);let l=e.schema.tags.find(u=>u.tag===r&&u.collection===a);if(!l){let u=e.schema.knownTags[r];if(u&&u.collection===a)e.schema.tags.push(Object.assign({},u,{default:!1})),l=u;else return u?i(o,"BAD_COLLECTION_TYPE",`${u.tag} used for ${a} collection, but expects ${u.collection??"scalar"}`,!0):i(o,"TAG_RESOLVE_FAILED",`Unresolved tag: ${r}`,!0),cs(s,e,t,i,r)}let c=cs(s,e,t,i,r,l),d=l.resolve?.(c,u=>i(o,"TAG_RESOLVE_FAILED",u),e.options)??c,f=O(d)?d:new y(d);return f.range=c.range,f.tag=r,l?.format&&(f.format=l.format),f}function Mt(s,e,t){let n=e.offset,i=Hn(e,s.options.strict,t);if(!i)return{value:"",type:null,comment:"",range:[n,n,n]};let o=i.mode===">"?y.BLOCK_FOLDED:y.BLOCK_LITERAL,r=e.source?Wn(e.source):[],a=r.length;for(let p=r.length-1;p>=0;--p){let h=r[p][1];if(h===""||h==="\r")a=p;else break}if(a===0){let p=i.chomp==="+"&&r.length>0?`
