...
${t}`)+"'";return e.implicitKey?n:Ue(n,t,Wt,ut(e,!1))}function Le(s,e){let{singleQuote:t}=e.options,n;if(t===!1)n=Ge;else{let i=s.includes('"'),o=s.includes("'");i&&!o?n=Ht:o&&!i?n=Ge:n=t?Ht:Ge}return n(s,e)}var zt;try{zt=new RegExp(`(^|(?<!
))
+(?!
|$)`,"g")}catch{zt=/\n+(?!\n|$)/g}function ft({comment:s,type:e,value:t},n,i,o){let{blockQuote:r,commentString:a,lineWidth:l}=n.options;if(!r||/\n[\t ]+$/.test(t))return Le(t,n);let c=n.indent||(n.forceBlockIndent||pt(t)?"  ":""),d=r==="literal"?!0:r==="folded"||e===y.BLOCK_FOLDED?!1:e===y.BLOCK_LITERAL?!0:!Bn(t,l,c.length);if(!t)return d?`|
`:`>
...
${t.indent}`)}}else(A===""||A[0]===`
`)&&(v="");return h+=v+A,t.inFlow?x&&n&&n():S&&!x?h+=se(h,t.indent,c(S)):p&&i&&i(),h}function ht(s,e){(s==="debug"||s==="warn")&&console.warn(e)}var mt="<<",H={identify:s=>s===mt||typeof s=="symbol"&&s.description===mt,default:"key",tag:"tag:yaml.org,2002:merge",test:/^<<$/,resolve:()=>Object.assign(new y(Symbol(mt)),{addToJSMap:Xt}),stringify:()=>mt},Ts=(s,e)=>(H.identify(e)||N(e)&&(!e.type||e.type===y.PLAIN)&&H.identify(e.value))&&s?.doc.schema.tags.some(t=>t.tag===H.tag&&t.default);function Xt(s,e,t){if(t=s&&j(t)?t.resolve(s.doc):t,G(t))for(let n of t.items)Qt(s,e,n);else if(Array.isArray(t))for(let n of t)Qt(s,e,n);else Qt(s,e,t)}function Qt(s,e,t){let n=s&&j(t)?t.resolve(s.doc):t;if(!U(n))throw new Error("Merge sources must be maps or map aliases");let i=n.toJSON(null,s,Map);for(let[o,r]of i)e instanceof Map?e.has(o)||e.set(o,r):e instanceof Set?e.add(o):Object.prototype.hasOwnProperty.call(e,o)||Object.defineProperty(e,o,{value:r,writable:!0,enumerable:!0,configurable:!0});return e}function gt(s,e,{key:t,value:n}){if(E(t)&&t.addToJSMap)t.addToJSMap(s,e,n);else if(Ts(s,t))Xt(s,e,n);else{let i=$(t,"",s);if(e instanceof Map)e.set(i,$(n,i,s));else if(e instanceof Set)e.add(i);else{let o=qn(t,i,s),r=$(n,o,s);o in e?Object.defineProperty(e,o,{value:r,writable:!0,enumerable:!0,configurable:!0}):e[o]=r}}return e}function qn(s,e,t){if(e===null)return"";if(typeof e!="object")return String(e);if(E(s)&&t?.doc){let n=dt(t.doc,{});n.anchors=new Set;for(let o of t.anchors.keys())n.anchors.add(o.anchor);n.inFlow=!0,n.inStringifyKey=!0;let i=s.toString(n);if(!t.mapKeyWarned){let o=JSON.stringify(i);o.length>40&&(o=o.substring(0,36)+'..."'),ht(t.doc.options.logLevel,`Keys with collection values will be stringified due to JS Object restrictions: ${o}. Set mapAsMap: true to use object keys.`),t.mapKeyWarned=!0}return i}return JSON.stringify(e)}function Ee(s,e,t){let n=ae(s,void 0,t),i=ae(e,void 0,t);return new C(n,i)}var C=class s{constructor(e,t=null){Object.defineProperty(this,B,{value:Vt}),this.key=e,this.value=t}clone(e){let{key:t,value:n}=this;return E(t)&&(t=t.clone(e)),E(n)&&(n=n.clone(e)),new s(t,n)}toJSON(e,t){let n=t?.mapAsMap?new Map:{};return gt(t,n,this)}toString(e,t,n){return e?.doc?Cs(this,e,t,n):JSON.stringify(this)}};function bt(s,e,t){return(e.inFlow??s.flow?Un:Fn)(s,e,t)}function Fn({comment:s,items:e},t,{blockItemPrefix:n,flowChars:i,itemIndent:o,onChompKeep:r,onComment:a}){let{indent:l,options:{commentString:c}}=t,d=Object.assign({},t,{indent:o,type:null}),f=!1,u=[];for(let g=0;g<e.length;++g){let p=e[g],h=null;if(E(p))!f&&p.spaceBefore&&u.push(""),yt(t,u,p.commentBefore,f),p.comment&&(h=p.comment);else if(L(p)){let k=E(p.key)?p.key:null;k&&(!f&&k.spaceBefore&&u.push(""),yt(t,u,k.commentBefore,f))}f=!1;let w=ce(p,d,()=>h=null,()=>f=!0);h&&(w+=se(w,o,c(h))),f&&h&&(f=!1),u.push(n+w)}let m;if(u.length===0)m=i.start+i.end;else{m=u[0];for(let g=1;g<u.length;++g){let p=u[g];m+=p?`
${l}${p}`:`
`}}return s?(m+=`
`+V(c(s),l),a&&a()):f&&r&&r(),m}function Un({items:s},e,{flowChars:t,itemIndent:n}){let{indent:i,indentStep:o,flowCollectionPadding:r,options:{commentString:a}}=e;n+=o;let l=Object.assign({},e,{indent:n,inFlow:!0,type:null}),c=!1,d=0,f=[];for(let g=0;g<s.length;++g){let p=s[g],h=null;if(E(p))p.spaceBefore&&f.push(""),yt(e,f,p.commentBefore,!1),p.comment&&(h=p.comment);else if(L(p)){let k=E(p.key)?p.key:null;k&&(k.spaceBefore&&f.push(""),yt(e,f,k.commentBefore,!1),k.comment&&(c=!0));let S=E(p.value)?p.value:null;S?(S.comment&&(h=S.comment),S.commentBefore&&(c=!0)):p.value==null&&k?.comment&&(h=k.comment)}h&&(c=!0);let w=ce(p,l,()=>h=null);g<s.length-1&&(w+=","),h&&(w+=se(w,n,a(h))),!c&&(f.length>d||w.includes(`
