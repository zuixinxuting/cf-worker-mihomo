...
</html>`}var $u={async fetch(s,e){let t=new URL(s.url),n={url:t,urls:t.searchParams.getAll("url"),userAgent:s.headers.get("User-Agent"),rule:t.searchParams.get("template"),singbox:t.searchParams.get("singbox")==="true",mihomo:t.searchParams.get("mihomo")==="true",v2ray:t.searchParams.get("v2ray")==="true",udp:t.searchParams.get("udp")==="true",udp_fragment:t.searchParams.get("udp_frag")==="true",tls_fragment:t.searchParams.get("tls_frag")==="true",exclude_package:t.searchParams.get("ep")==="true",exclude_address:t.searchParams.get("ea")==="true",tailscale:t.searchParams.get("tailscale")==="true",tun:t.searchParams.get("tun")==="true",adgdns:t.searchParams.get("adgdns")==="true",IMG:e.IMG||_n,sub:e.SUB||An,Mihomo_default:e.MIHOMOTOP||Nn,singbox_1_11:e.SINGBOX_1_11||Ln,singbox_1_12:e.SINGBOX_1_12||On,singbox_1_12_alpha:e.SINGBOX_1_12_ALPHA||En,singbox_1_13:e.SINGBOX_1_13||Cn,singbox_1_14:process.env.SINGBOX_1_14||In,beian:e.BEIAN||Tn,beianurl:e.BEIANURL||Mn,configs:$n(e.MIHOMO,e.SINGBOX)};if(n.modes=Pn(n.sub,n.userAgent),n.urls.length===1&&n.urls[0].includes(",")&&(n.urls=n.urls[0].split(",").map(i=>i.trim())),n.urls.length===0||n.urls[0]==="")return new Response(await Vn(n),{status:200,headers:{"Content-Type":"text/html; charset=utf-8"}});try{let i,o,r;n.singbox?i=await Fn(n):n.mihomo?i=await Bn(n):n.v2ray&&(i=await Un(n));let a=i.headers;return o=new Headers(a),r=i.status,o.set("Content-Type","application/json; charset=utf-8"),o.set("Profile-web-page-url",t.origin),new Response(i.data,{status:r,headers:o})}catch(i){return new Response(i.message,{status:400,headers:{"Content-Type":"application/json; charset=utf-8"}})}}};export{$u as default};
