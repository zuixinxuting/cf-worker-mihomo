...
$&`).replace(/(?:^|\n)([\t ].*)(?:([\n\t ]*)\n(?![\n\t ]))?/g,"$1$2").replace(/\n+/g,`$&${c}`),A=!1,O=pt(n,!0);r!=="folded"&&e!==y.BLOCK_FOLDED&&(O.onOverflow=()=>{A=!0});let b=Ve(`${S}${v}${h}`,c,ut,O);if(!A)return`>${x}
...
${l}`);if(r){let u=d=>d.default&&d.tag!=="tag:yaml.org,2002:str"&&d.test?.test(f),{compat:h,tags:g}=e.doc.schema;if(g.some(u)||h?.some(u))return Le(o,e)}return a?f:Ve(f,l,zt,pt(e,!1))}function le(s,e,t,n){let{implicitKey:i,inFlow:o}=e,r=typeof s.value=="string"?s:Object.assign({},s,{value:String(s.value)}),{type:a}=s;a!==y.QUOTE_DOUBLE&&/[\x00-\x08\x0b-\x1f\x7f-\x9f\u{D800}-\u{DFFF}]/u.test(r.value)&&(a=y.QUOTE_DOUBLE);let l=p=>{switch(p){case y.BLOCK_FOLDED:case y.BLOCK_LITERAL:return i||o?Le(r.value,e):dt(r,e,t,n);case y.QUOTE_DOUBLE:return Ye(r.value,e);case y.QUOTE_SINGLE:return Xt(r.value,e);case y.PLAIN:return zn(r,e,t,n);default:return null}},c=l(a);if(c===null){let{defaultKeyType:p,defaultStringType:f}=e.options,u=i&&p||f;if(c=l(u),c===null)throw new Error(`Unsupported default string type ${u}`)}return c}function ht(s,e){let t=Object.assign({blockQuote:!0,commentString:Is,defaultKeyType:null,defaultStringType:"PLAIN",directives:null,doubleQuotedAsJSON:!1,doubleQuotedMinMultiLineLength:40,falseStr:"false",flowCollectionPadding:!0,indentSeq:!0,lineWidth:80,minContentWidth:20,nullStr:"null",simpleKeys:!1,singleQuote:null,trueStr:"true",verifyAliasOrder:!0},s.schema.toStringOptions,e),n;switch(t.collectionStyle){case"block":n=!1;break;case"flow":n=!0;break;default:n=null}return{anchors:new Set,doc:s,flowCollectionPadding:t.flowCollectionPadding?" ":"",indent:"",indentStep:typeof t.indent=="number"?" ".repeat(t.indent):"  ",inFlow:n,options:t}}function Xn(s,e){if(e.tag){let i=s.filter(o=>o.tag===e.tag);if(i.length>0)return i.find(o=>o.format===e.format)??i[0]}let t,n;if(N(e)){n=e.value;let i=s.filter(o=>o.identify?.(n));if(i.length>1){let o=i.filter(r=>r.test);o.length>0&&(i=o)}t=i.find(o=>o.format===e.format)??i.find(o=>!o.format)}else n=e,t=s.find(i=>i.nodeClass&&n instanceof i.nodeClass);if(!t){let i=n?.constructor?.name??(n===null?"null":typeof n);throw new Error(`Tag not resolved for ${i} value`)}return t}function Qn(s,e,{anchors:t,doc:n}){if(!n.directives)return"";let i=[],o=(N(s)||E(s))&&s.anchor;o&&lt(o)&&(t.add(o),i.push(`&${o}`));let r=s.tag??(e.default?null:e.tag);return r&&i.push(n.directives.tagString(r)),i.join(" ")}function ce(s,e,t,n){if(_(s))return s.toString(e,t,n);if(K(s)){if(e.doc.directives)return s.toString(e);if(e.resolvedAliases?.has(s))throw new TypeError("Cannot stringify circular structure without alias nodes");e.resolvedAliases?e.resolvedAliases.add(s):e.resolvedAliases=new Set([s]),s=s.resolve(e.doc)}let i,o=L(s)?s:e.doc.createNode(s,{onTagObj:l=>i=l});i??(i=Xn(e.doc.schema.tags,o));let r=Qn(o,i,e);r.length>0&&(e.indentAtStart=(e.indentAtStart??0)+r.length+1);let a=typeof i.stringify=="function"?i.stringify(o,e,t,n):N(o)?le(o,e,t,n):o.toString(e,t,n);return r?N(o)||a[0]==="{"||a[0]==="["?`${r} ${a}`:`${r}
${e.indent}${a}`:a}function Ms({key:s,value:e},t,n,i){let{allNullValues:o,doc:r,indent:a,indentStep:l,options:{commentString:c,indentSeq:p,simpleKeys:f}}=t,u=L(s)&&s.comment||null;if(f){if(u)throw new Error("With simple keys, key nodes cannot have comments");if(E(s)||!L(s)&&typeof s=="object"){let O="With simple keys, collection cannot be used as a key value";throw new Error(O)}}let h=!f&&(!s||u&&e==null&&!t.inFlow||E(s)||(N(s)?s.type===y.BLOCK_FOLDED||s.type===y.BLOCK_LITERAL:typeof s=="object"));t=Object.assign({},t,{allNullValues:!1,implicitKey:!h&&(f||!o),indent:a+l});let g=!1,d=!1,m=ce(s,t,()=>g=!0,()=>d=!0);if(!h&&!t.inFlow&&m.length>1024){if(f)throw new Error("With simple keys, single line scalar must not span more than 1024 characters");h=!0}if(t.inFlow){if(o||e==null)return g&&n&&n(),m===""?"?":h?`? ${m}`:m}else if(o&&!f||e==null&&h)return m=`? ${m}`,u&&!g?m+=te(m,t.indent,c(u)):d&&i&&i(),m;g&&(u=null),h?(u&&(m+=te(m,t.indent,c(u))),m=`? ${m}
${a}:`):(m=`${m}:`,u&&(m+=te(m,t.indent,c(u))));let w,S,k;L(e)?(w=!!e.spaceBefore,S=e.commentBefore,k=e.comment):(w=!1,S=null,k=null,e&&typeof e=="object"&&(e=r.createNode(e))),t.implicitKey=!1,!h&&!u&&N(e)&&(t.indentAtStart=m.length+1),d=!1,!p&&l.length>=2&&!t.inFlow&&!h&&G(e)&&!e.flow&&!e.tag&&!e.anchor&&(t.indent=t.indent.substring(2));let x=!1,v=ce(e,t,()=>x=!0,()=>d=!0),A=" ";if(u||w||S){if(A=w?`
`:"",S){let O=c(S);A+=`
...
`&&(f+=`
`);break;default:f+=`
`}let g=n+i.length+e.source.length;return{value:f,type:o,comment:i.comment,range:[n,g,g]}}function oi({offset:s,props:e},t,n){if(e[0].type!=="block-scalar-header")return n(e[0],"IMPOSSIBLE","Block scalar header not found"),null;let{source:i}=e[0],o=i[0],r=0,a="",l=-1;for(let u=1;u<i.length;++u){let h=i[u];if(!a&&(h==="-"||h==="+"))a=h;else{let g=Number(h);!r&&g?r=g:l===-1&&(l=s+u)}}l!==-1&&n(l,"UNEXPECTED_TOKEN",`Block scalar header includes extra characters: ${i}`);let c=!1,p="",f=i.length;for(let u=1;u<e.length;++u){let h=e[u];switch(h.type){case"space":c=!0;case"newline":f+=h.source.length;break;case"comment":t&&!c&&n(h,"MISSING_CHAR","Comments must be separated from other tokens by white space characters"),f+=h.source.length,p=h.source.substring(1);break;case"error":n(h,"UNEXPECTED_TOKEN",h.message),f+=h.source.length;break;default:{let g=`Unexpected token in block scalar header: ${h.type}`;n(h,"UNEXPECTED_TOKEN",g);let d=h.source;d&&typeof d=="string"&&(f+=d.length)}}}return{mode:o,indent:r,chomp:a,comment:p,length:f}}function ri(s){let e=s.split(/\n( *)/),t=e[0],n=t.match(/^( *)/),o=[n?.[1]?[n[1],t.slice(n[1].length)]:["",t]];for(let r=1;r<e.length;r+=2)o.push([e[r],e[r+1]]);return o}function Dt(s,e,t){let{offset:n,type:i,source:o,end:r}=s,a,l,c=(u,h,g)=>t(n+u,h,g);switch(i){case"scalar":a=y.PLAIN,l=ai(o,c);break;case"single-quoted-scalar":a=y.QUOTE_SINGLE,l=li(o,c);break;case"double-quoted-scalar":a=y.QUOTE_DOUBLE,l=ci(o,c);break;default:return t(s,"UNEXPECTED_TOKEN",`Expected a flow scalar value, but found: ${i}`),{value:"",type:null,comment:"",range:[n,n+o.length,n+o.length]}}let p=n+o.length,f=ie(r,p,e,t);return{value:l,type:a,comment:f.comment,range:[n,p,f.offset]}}function ai(s,e){let t="";switch(s[0]){case"	":t="a tab character";break;case",":t="flow indicator character ,";break;case"%":t="directive indicator character %";break;case"|":case">":{t=`block scalar indicator ${s[0]}`;break}case"@":case"`":{t=`reserved character ${s[0]}`;break}}return t&&e(0,"BAD_SCALAR_START",`Plain value cannot start with ${t}`),nn(s)}function li(s,e){return(s[s.length-1]!=="'"||s.length===1)&&e(s.length,"MISSING_CHAR","Missing closing 'quote"),nn(s.slice(1,-1)).replace(/''/g,"'")}function nn(s){let e,t;try{e=new RegExp(`(.*?)(?<![ 	])[ 	]*\r?
`,"sy"),t=new RegExp(`[ 	]*(.*?)(?:(?<![ 	])[ 	]*)?\r?
...
`))if(i===`
`){let{fold:o,offset:r}=fi(s,n);t+=o,n=r}else if(i==="\\"){let o=s[++n],r=ui[o];if(r)t+=r;else if(o===`
