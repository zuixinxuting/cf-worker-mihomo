...
${t}`)+"'";return e.implicitKey?n:Ue(n,t,Ht,ut(e,!1))}function Le(s,e){let{singleQuote:t}=e.options,n;if(t===!1)n=Ge;else{let i=s.includes('"'),o=s.includes("'");i&&!o?n=Wt:o&&!i?n=Ge:n=t?Wt:Ge}return n(s,e)}var zt;try{zt=new RegExp(`(^|(?<!
))
+(?!
