...
${e}${s.slice(x+1,v)}`)}return S}function Is(s,e,t){let n=e,i=e+1,o=s[i];for(;o===" "||o==="	";)if(e<i+t)o=s[++e];else{do o=s[++e];while(o&&o!==`
`);n=e,i=e+1,o=s[i]}return n}var pt=(s,e)=>({indentAtStart:e?s.indent.length:s.indentAtStart,lineWidth:s.options.lineWidth,minContentWidth:s.options.minContentWidth}),mt=s=>/^(%|---|\.\.\.)/m.test(s);function zn(s,e,t){if(!e||e<0)return!1;let n=e-t,i=s.length;if(i<=n)return!1;for(let o=0,r=0;o<i;++o)if(s[o]===`
...
+(?!
|$)`,"g")}catch{Qt=/\n+(?!\n|$)/g}function dt({comment:s,type:e,value:t},n,i,o){let{blockQuote:r,commentString:a,lineWidth:l}=n.options;if(!r||/\n[\t ]+$/.test(t))return Le(t,n);let c=n.indent||(n.forceBlockIndent||mt(t)?"  ":""),p=r==="literal"?!0:r==="folded"||e===y.BLOCK_FOLDED?!1:e===y.BLOCK_LITERAL?!0:!zn(t,l,c.length);if(!t)return p?`|
`:`>
...
$&`).replace(/(?:^|\n)([\t ].*)(?:([\n\t ]*)\n(?![\n\t ]))?/g,"$1$2").replace(/\n+/g,`$&${c}`),_=!1,E=pt(n,!0);r!=="folded"&&e!==y.BLOCK_FOLDED&&(E.onOverflow=()=>{_=!0});let b=Ve(`${S}${v}${h}`,c,ft,E);if(!_)return`>${x}
${c}${b}`}return t=t.replace(/\n+/g,`$&${c}`),`|${x}
${c}${S}${t}${h}`}function Xn(s,e,t,n){let{type:i,value:o}=s,{actualString:r,implicitKey:a,indent:l,indentStep:c,inFlow:p}=e;if(a&&o.includes(`
...
${l}`);if(r){let f=d=>d.default&&d.tag!=="tag:yaml.org,2002:str"&&d.test?.test(u),{compat:h,tags:g}=e.doc.schema;if(g.some(f)||h?.some(f))return Le(o,e)}return a?u:Ve(u,l,zt,pt(e,!1))}function ce(s,e,t,n){let{implicitKey:i,inFlow:o}=e,r=typeof s.value=="string"?s:Object.assign({},s,{value:String(s.value)}),{type:a}=s;a!==y.QUOTE_DOUBLE&&/[\x00-\x08\x0b-\x1f\x7f-\x9f\u{D800}-\u{DFFF}]/u.test(r.value)&&(a=y.QUOTE_DOUBLE);let l=p=>{switch(p){case y.BLOCK_FOLDED:case y.BLOCK_LITERAL:return i||o?Le(r.value,e):dt(r,e,t,n);case y.QUOTE_DOUBLE:return Ye(r.value,e);case y.QUOTE_SINGLE:return Xt(r.value,e);case y.PLAIN:return Xn(r,e,t,n);default:return null}},c=l(a);if(c===null){let{defaultKeyType:p,defaultStringType:u}=e.options,f=i&&p||u;if(c=l(f),c===null)throw new Error(`Unsupported default string type ${f}`)}return c}function ht(s,e){let t=Object.assign({blockQuote:!0,commentString:Cs,defaultKeyType:null,defaultStringType:"PLAIN",directives:null,doubleQuotedAsJSON:!1,doubleQuotedMinMultiLineLength:40,falseStr:"false",flowCollectionPadding:!0,indentSeq:!0,lineWidth:80,minContentWidth:20,nullStr:"null",simpleKeys:!1,singleQuote:null,trueStr:"true",verifyAliasOrder:!0},s.schema.toStringOptions,e),n;switch(t.collectionStyle){case"block":n=!1;break;case"flow":n=!0;break;default:n=null}return{anchors:new Set,doc:s,flowCollectionPadding:t.flowCollectionPadding?" ":"",indent:"",indentStep:typeof t.indent=="number"?" ".repeat(t.indent):"  ",inFlow:n,options:t}}function Qn(s,e){if(e.tag){let i=s.filter(o=>o.tag===e.tag);if(i.length>0)return i.find(o=>o.format===e.format)??i[0]}let t,n;if(A(e)){n=e.value;let i=s.filter(o=>o.identify?.(n));if(i.length>1){let o=i.filter(r=>r.test);o.length>0&&(i=o)}t=i.find(o=>o.format===e.format)??i.find(o=>!o.format)}else n=e,t=s.find(i=>i.nodeClass&&n instanceof i.nodeClass);if(!t){let i=n?.constructor?.name??(n===null?"null":typeof n);throw new Error(`Tag not resolved for ${i} value`)}return t}function Zn(s,e,{anchors:t,doc:n}){if(!n.directives)return"";let i=[],o=(A(s)||O(s))&&s.anchor;o&&lt(o)&&(t.add(o),i.push(`&${o}`));let r=s.tag??(e.default?null:e.tag);return r&&i.push(n.directives.tagString(r)),i.join(" ")}function ue(s,e,t,n){if(N(s))return s.toString(e,t,n);if(K(s)){if(e.doc.directives)return s.toString(e);if(e.resolvedAliases?.has(s))throw new TypeError("Cannot stringify circular structure without alias nodes");e.resolvedAliases?e.resolvedAliases.add(s):e.resolvedAliases=new Set([s]),s=s.resolve(e.doc)}let i,o=L(s)?s:e.doc.createNode(s,{onTagObj:l=>i=l});i??(i=Qn(e.doc.schema.tags,o));let r=Zn(o,i,e);r.length>0&&(e.indentAtStart=(e.indentAtStart??0)+r.length+1);let a=typeof i.stringify=="function"?i.stringify(o,e,t,n):A(o)?ce(o,e,t,n):o.toString(e,t,n);return r?A(o)||a[0]==="{"||a[0]==="["?`${r} ${a}`:`${r}
${e.indent}${a}`:a}function Ts({key:s,value:e},t,n,i){let{allNullValues:o,doc:r,indent:a,indentStep:l,options:{commentString:c,indentSeq:p,simpleKeys:u}}=t,f=L(s)&&s.comment||null;if(u){if(f)throw new Error("With simple keys, key nodes cannot have comments");if(O(s)||!L(s)&&typeof s=="object"){let E="With simple keys, collection cannot be used as a key value";throw new Error(E)}}let h=!u&&(!s||f&&e==null&&!t.inFlow||O(s)||(A(s)?s.type===y.BLOCK_FOLDED||s.type===y.BLOCK_LITERAL:typeof s=="object"));t=Object.assign({},t,{allNullValues:!1,implicitKey:!h&&(u||!o),indent:a+l});let g=!1,d=!1,m=ue(s,t,()=>g=!0,()=>d=!0);if(!h&&!t.inFlow&&m.length>1024){if(u)throw new Error("With simple keys, single line scalar must not span more than 1024 characters");h=!0}if(t.inFlow){if(o||e==null)return g&&n&&n(),m===""?"?":h?`? ${m}`:m}else if(o&&!u||e==null&&h)return m=`? ${m}`,f&&!g?m+=se(m,t.indent,c(f)):d&&i&&i(),m;g&&(f=null),h?(f&&(m+=se(m,t.indent,c(f))),m=`? ${m}
...
${t.indent}`)}}else(v===""||v[0]===`
`)&&(_="");return m+=_+v,t.inFlow?x&&n&&n():k&&!x?m+=se(m,t.indent,c(k)):d&&i&&i(),m}function gt(s,e){(s==="debug"||s==="warn")&&console.warn(e)}var yt="<<",W={identify:s=>s===yt||typeof s=="symbol"&&s.description===yt,default:"key",tag:"tag:yaml.org,2002:merge",test:/^<<$/,resolve:()=>Object.assign(new y(Symbol(yt)),{addToJSMap:es}),stringify:()=>yt},Ms=(s,e)=>(W.identify(e)||A(e)&&(!e.type||e.type===y.PLAIN)&&W.identify(e.value))&&s?.doc.schema.tags.some(t=>t.tag===W.tag&&t.default);function es(s,e,t){if(t=s&&K(t)?t.resolve(s.doc):t,G(t))for(let n of t.items)Zt(s,e,n);else if(Array.isArray(t))for(let n of t)Zt(s,e,n);else Zt(s,e,t)}function Zt(s,e,t){let n=s&&K(t)?t.resolve(s.doc):t;if(!U(n))throw new Error("Merge sources must be maps or map aliases");let i=n.toJSON(null,s,Map);for(let[o,r]of i)e instanceof Map?e.has(o)||e.set(o,r):e instanceof Set?e.add(o):Object.prototype.hasOwnProperty.call(e,o)||Object.defineProperty(e,o,{value:r,writable:!0,enumerable:!0,configurable:!0});return e}function bt(s,e,{key:t,value:n}){if(L(t)&&t.addToJSMap)t.addToJSMap(s,e,n);else if(Ms(s,t))es(s,e,n);else{let i=$(t,"",s);if(e instanceof Map)e.set(i,$(n,i,s));else if(e instanceof Set)e.add(i);else{let o=ei(t,i,s),r=$(n,o,s);o in e?Object.defineProperty(e,o,{value:r,writable:!0,enumerable:!0,configurable:!0}):e[o]=r}}return e}function ei(s,e,t){if(e===null)return"";if(typeof e!="object")return String(e);if(L(s)&&t?.doc){let n=ht(t.doc,{});n.anchors=new Set;for(let o of t.anchors.keys())n.anchors.add(o.anchor);n.inFlow=!0,n.inStringifyKey=!0;let i=s.toString(n);if(!t.mapKeyWarned){let o=JSON.stringify(i);o.length>40&&(o=o.substring(0,36)+'..."'),gt(t.doc.options.logLevel,`Keys with collection values will be stringified due to JS Object restrictions: ${o}. Set mapAsMap: true to use object keys.`),t.mapKeyWarned=!0}return i}return JSON.stringify(e)}function Oe(s,e,t){let n=le(s,void 0,t),i=le(e,void 0,t);return new C(n,i)}var C=class s{constructor(e,t=null){Object.defineProperty(this,R,{value:Jt}),this.key=e,this.value=t}clone(e){let{key:t,value:n}=this;return L(t)&&(t=t.clone(e)),L(n)&&(n=n.clone(e)),new s(t,n)}toJSON(e,t){let n=t?.mapAsMap?new Map:{};return bt(t,n,this)}toString(e,t,n){return e?.doc?Ts(this,e,t,n):JSON.stringify(this)}};function St(s,e,t){return(e.inFlow??s.flow?si:ti)(s,e,t)}function ti({comment:s,items:e},t,{blockItemPrefix:n,flowChars:i,itemIndent:o,onChompKeep:r,onComment:a}){let{indent:l,options:{commentString:c}}=t,p=Object.assign({},t,{indent:o,type:null}),u=!1,f=[];for(let g=0;g<e.length;++g){let d=e[g],m=null;if(L(d))!u&&d.spaceBefore&&f.push(""),wt(t,f,d.commentBefore,u),d.comment&&(m=d.comment);else if(N(d)){let S=L(d.key)?d.key:null;S&&(!u&&S.spaceBefore&&f.push(""),wt(t,f,S.commentBefore,u))}u=!1;let w=ue(d,p,()=>m=null,()=>u=!0);m&&(w+=se(w,o,c(m))),u&&m&&(u=!1),f.push(n+w)}let h;if(f.length===0)h=i.start+i.end;else{h=f[0];for(let g=1;g<f.length;++g){let d=f[g];h+=d?`
${l}${d}`:`
`}}return s?(h+=`
`+V(c(s),l),a&&a()):u&&r&&r(),h}function si({items:s},e,{flowChars:t,itemIndent:n}){let{indent:i,indentStep:o,flowCollectionPadding:r,options:{commentString:a}}=e;n+=o;let l=Object.assign({},e,{indent:n,inFlow:!0,type:null}),c=!1,p=0,u=[];for(let g=0;g<s.length;++g){let d=s[g],m=null;if(L(d))d.spaceBefore&&u.push(""),wt(e,u,d.commentBefore,!1),d.comment&&(m=d.comment);else if(N(d)){let S=L(d.key)?d.key:null;S&&(S.spaceBefore&&u.push(""),wt(e,u,S.commentBefore,!1),S.comment&&(c=!0));let k=L(d.value)?d.value:null;k?(k.comment&&(m=k.comment),k.commentBefore&&(c=!0)):d.value==null&&S?.comment&&(m=S.comment)}m&&(c=!0);let w=ue(d,l,()=>m=null);g<s.length-1&&(w+=","),m&&(w+=se(w,n,a(m))),!c&&(u.length>p||w.includes(`
...
`&&(u+=`
`);break;default:u+=`
`}let g=n+i.length+e.source.length;return{value:u,type:o,comment:i.comment,range:[n,g,g]}}function ri({offset:s,props:e},t,n){if(e[0].type!=="block-scalar-header")return n(e[0],"IMPOSSIBLE","Block scalar header not found"),null;let{source:i}=e[0],o=i[0],r=0,a="",l=-1;for(let f=1;f<i.length;++f){let h=i[f];if(!a&&(h==="-"||h==="+"))a=h;else{let g=Number(h);!r&&g?r=g:l===-1&&(l=s+f)}}l!==-1&&n(l,"UNEXPECTED_TOKEN",`Block scalar header includes extra characters: ${i}`);let c=!1,p="",u=i.length;for(let f=1;f<e.length;++f){let h=e[f];switch(h.type){case"space":c=!0;case"newline":u+=h.source.length;break;case"comment":t&&!c&&n(h,"MISSING_CHAR","Comments must be separated from other tokens by white space characters"),u+=h.source.length,p=h.source.substring(1);break;case"error":n(h,"UNEXPECTED_TOKEN",h.message),u+=h.source.length;break;default:{let g=`Unexpected token in block scalar header: ${h.type}`;n(h,"UNEXPECTED_TOKEN",g);let d=h.source;d&&typeof d=="string"&&(u+=d.length)}}}return{mode:o,indent:r,chomp:a,comment:p,length:u}}function ai(s){let e=s.split(/\n( *)/),t=e[0],n=t.match(/^( *)/),o=[n?.[1]?[n[1],t.slice(n[1].length)]:["",t]];for(let r=1;r<e.length;r+=2)o.push([e[r],e[r+1]]);return o}function Dt(s,e,t){let{offset:n,type:i,source:o,end:r}=s,a,l,c=(f,h,g)=>t(n+f,h,g);switch(i){case"scalar":a=y.PLAIN,l=li(o,c);break;case"single-quoted-scalar":a=y.QUOTE_SINGLE,l=ci(o,c);break;case"double-quoted-scalar":a=y.QUOTE_DOUBLE,l=ui(o,c);break;default:return t(s,"UNEXPECTED_TOKEN",`Expected a flow scalar value, but found: ${i}`),{value:"",type:null,comment:"",range:[n,n+o.length,n+o.length]}}let p=n+o.length,u=oe(r,p,e,t);return{value:l,type:a,comment:u.comment,range:[n,p,u.offset]}}function li(s,e){let t="";switch(s[0]){case"	":t="a tab character";break;case",":t="flow indicator character ,";break;case"%":t="directive indicator character %";break;case"|":case">":{t=`block scalar indicator ${s[0]}`;break}case"@":case"`":{t=`reserved character ${s[0]}`;break}}return t&&e(0,"BAD_SCALAR_START",`Plain value cannot start with ${t}`),sn(s)}function ci(s,e){return(s[s.length-1]!=="'"||s.length===1)&&e(s.length,"MISSING_CHAR","Missing closing 'quote"),sn(s.slice(1,-1)).replace(/''/g,"'")}function sn(s){let e,t;try{e=new RegExp(`(.*?)(?<![ 	])[ 	]*\r?
`,"sy"),t=new RegExp(`[ 	]*(.*?)(?:(?<![ 	])[ 	]*)?\r?
`,"sy")}catch{e=/(.*?)[ \t]*\r?\n/sy,t=/[ \t]*(.*?)[ \t]*\r?\n/sy}let n=e.exec(s);if(!n)return s;let i=n[1],o=" ",r=e.lastIndex;for(t.lastIndex=r;n=t.exec(s);)n[1]===""?o===`
`?i+=o:o=`
`:(i+=o+n[1],o=" "),r=t.lastIndex;let a=/[ \t]*(.*)/sy;return a.lastIndex=r,n=a.exec(s),i+o+(n?.[1]??"")}function ui(s,e){let t="";for(let n=1;n<s.length-1;++n){let i=s[n];if(!(i==="\r"&&s[n+1]===`
`))if(i===`
`){let{fold:o,offset:r}=fi(s,n);t+=o,n=r}else if(i==="\\"){let o=s[++n],r=di[o];if(r)t+=r;else if(o===`
`)for(o=s[n+1];o===" "||o==="	";)o=s[++n+1];else if(o==="\r"&&s[n+1]===`
`)for(o=s[++n+1];o===" "||o==="	";)o=s[++n+1];else if(o==="x"||o==="u"||o==="U"){let a={x:2,u:4,U:8}[o];t+=pi(s,n+1,a,e),n+=a}else{let a=s.substr(n-1,2);e(n-1,"BAD_DQ_ESCAPE",`Invalid escape sequence ${a}`),t+=a}}else if(i===" "||i==="	"){let o=n,r=s[n+1];for(;r===" "||r==="	";)r=s[++n+1];r!==`
`&&!(r==="\r"&&s[n+2]===`
`)&&(t+=n>o?s.slice(o,n+1):i)}else t+=i}return(s[s.length-1]!=='"'||s.length===1)&&e(s.length,"MISSING_CHAR",'Missing closing "quote'),t}function fi(s,e){let t="",n=s[e+1];for(;(n===" "||n==="	"||n===`
`||n==="\r")&&!(n==="\r"&&s[e+2]!==`
`);)n===`
`&&(t+=`
`),e+=1,n=s[e+1];return t||(t=" "),{fold:t,offset:e}}var di={0:"\0",a:"\x07",b:"\b",e:"\x1B",f:"\f",n:`
`,r:"\r",t:"	",v:"\v",N:"\x85",_:"\xA0",L:"\u2028",P:"\u2029"," ":" ",'"':'"',"/":"/","\\":"\\","	":"	"};function pi(s,e,t,n){let i=s.substr(e,t),r=i.length===t&&/^[0-9a-fA-F]+$/.test(i)?parseInt(i,16):NaN;if(isNaN(r)){let a=s.substr(e-2,t+2);return n(e-2,"BAD_DQ_ESCAPE",`Invalid escape sequence ${a}`),a}return String.fromCodePoint(r)}function ds(s,e,t,n){let{value:i,type:o,comment:r,range:a}=e.type==="block-scalar"?Pt(s,e,n):Dt(e,s.options.strict,n),l=t?s.directives.tagName(t.source,u=>n(t,"TAG_RESOLVE_FAILED",u)):null,c;s.options.stringKeys&&s.atKey?c=s.schema[j]:l?c=mi(s.schema,i,l,t,n):e.type==="scalar"?c=hi(s,i,e,n):c=s.schema[j];let p;try{let u=c.resolve(i,f=>n(t??e,"TAG_RESOLVE_FAILED",f),s.options);p=A(u)?u:new y(u)}catch(u){let f=u instanceof Error?u.message:String(u);n(t??e,"TAG_RESOLVE_FAILED",f),p=new y(i)}return p.range=a,p.source=i,o&&(p.type=o),l&&(p.tag=l),c.format&&(p.format=c.format),r&&(p.comment=r),p}function mi(s,e,t,n,i){if(t==="!")return s[j];let o=[];for(let a of s.tags)if(!a.collection&&a.tag===t)if(a.default&&a.test)o.push(a);else return a;for(let a of o)if(a.test?.test(e))return a;let r=s.knownTags[t];return r&&!r.collection?(s.tags.push(Object.assign({},r,{default:!1,test:void 0})),r):(i(n,"TAG_RESOLVE_FAILED",`Unresolved tag: ${t}`,t!=="tag:yaml.org,2002:str"),s[j])}function hi({atKey:s,directives:e,schema:t},n,i,o){let r=t.tags.find(a=>(a.default===!0||s&&a.default==="key")&&a.test?.test(n))||t[j];if(t.compat){let a=t.compat.find(l=>l.default&&l.test?.test(n))??t[j];if(r.tag!==a.tag){let l=e.tagString(r.tag),c=e.tagString(a.tag),p=`Value may be parsed as either ${l} or ${c}`;o(i,"TAG_RESOLVE_FAILED",p,!0)}}return r}function nn(s,e,t){if(e){t??(t=e.length);for(let n=t-1;n>=0;--n){let i=e[n];switch(i.type){case"space":case"comment":case"newline":s-=i.source.length;continue}for(i=e[++n];i?.type==="space";)s+=i.source.length,i=e[++n];break}}return s}var gi={composeNode:ps,composeEmptyNode:Rt};function ps(s,e,t,n){let i=s.atKey,{spaceBefore:o,comment:r,anchor:a,tag:l}=t,c,p=!0;switch(e.type){case"alias":c=yi(s,e,n),(a||l)&&n(e,"ALIAS_PROPS","An alias node must not specify any properties");break;case"scalar":case"single-quoted-scalar":case"double-quoted-scalar":case"block-scalar":c=ds(s,e,l,n),a&&(c.anchor=a.source.substring(1));break;case"block-map":case"block-seq":case"flow-collection":c=tn(gi,s,e,t,n),a&&(c.anchor=a.source.substring(1));break;default:{let u=e.type==="error"?e.message:`Unsupported token (type: ${e.type})`;n(e,"UNEXPECTED_TOKEN",u),c=Rt(s,e.offset,void 0,null,t,n),p=!1}}return a&&c.anchor===""&&n(a,"BAD_ALIAS","Anchor cannot be an empty string"),i&&s.options.stringKeys&&(!A(c)||typeof c.value!="string"||c.tag&&c.tag!=="tag:yaml.org,2002:str")&&n(l??e,"NON_STRING_KEY","With stringKeys, all keys must be strings"),o&&(c.spaceBefore=!0),r&&(e.type==="scalar"&&e.source===""?c.comment=r:c.commentBefore=r),s.options.keepSourceTokens&&p&&(c.srcToken=e),c}function Rt(s,e,t,n,{spaceBefore:i,comment:o,anchor:r,tag:a,end:l},c){let p={type:"scalar",offset:nn(e,t,n),indent:-1,source:""},u=ds(s,p,a,c);return r&&(u.anchor=r.source.substring(1),u.anchor===""&&c(r,"BAD_ALIAS","Anchor cannot be an empty string")),i&&(u.spaceBefore=!0),o&&(u.comment=o,u.range[2]=l),u}function yi({options:s},{offset:e,source:t,end:n},i){let o=new te(t.substring(1));o.source===""&&i(e,"BAD_ALIAS","Alias cannot be an empty string"),o.source.endsWith(":")&&i(e+t.length-1,"BAD_ALIAS","Alias ending in : is ambiguous",!0);let r=e+t.length,a=oe(n,r,s.strict,i);return o.range=[e,r,a.offset],a.comment&&(o.comment=a.comment),o}function on(s,e,{offset:t,start:n,value:i,end:o},r){let a=Object.assign({_directives:e},s),l=new ne(void 0,a),c={atKey:!1,atRoot:!0,directives:l.directives,options:l.options,schema:l.schema},p=ie(n,{indicator:"doc-start",next:i??o?.[0],offset:t,onError:r,parentIndent:0,startOnNewline:!0});p.found&&(l.directives.docStart=!0,i&&(i.type==="block-map"||i.type==="block-seq")&&!p.hasNewline&&r(p.end,"MISSING_CHAR","Block collection cannot start on same line with directives-end marker")),l.contents=i?ps(c,i,p,r):Rt(c,p.end,n,null,p,r);let u=l.contents.range[2],f=oe(o,u,!1,r);return f.comment&&(l.comment=f.comment),l.range=[t,u,f.offset],l}function tt(s){if(typeof s=="number")return[s,s+1];if(Array.isArray(s))return s.length===2?s:[s[0],s[1]];let{offset:e,source:t}=s;return[e,e+(typeof t=="string"?t.length:1)]}function rn(s){let e="",t=!1,n=!1;for(let i=0;i<s.length;++i){let o=s[i];switch(o[0]){case"#":e+=(e===""?"":n?`

`:`
`)+(o.substring(1)||" "),t=!0,n=!1;break;case"%":s[i+1]?.[0]!=="#"&&(i+=1),t=!1;break;default:t||(n=!0),t=!1}}return{comment:e,afterEmptyLine:n}}var Se=class{constructor(e={}){this.doc=null,this.atDirectives=!1,this.prelude=[],this.errors=[],this.warnings=[],this.onError=(t,n,i,o)=>{let r=tt(t);o?this.warnings.push(new Pe(r,n,i)):this.errors.push(new q(r,n,i))},this.directives=new ee({version:e.version||"1.2"}),this.options=e}decorate(e,t){let{comment:n,afterEmptyLine:i}=rn(this.prelude);if(n){let o=e.contents;if(t)e.comment=e.comment?`${e.comment}
...
`&&o>=this.pos&&o+1+t>a)e=o;else break}while(!0);return yield De,yield*this.pushToIndex(e+1,!0),yield*this.parseLineStart()}*parsePlainScalar(){let e=this.flowLevel>0,t=this.pos-1,n=this.pos-1,i;for(;i=this.buffer[++n];)if(i===":"){let o=this.buffer[n+1];if(Q(o)||e&&Kt.has(o))break;t=n}else if(Q(i)){let o=this.buffer[n+1];if(i==="\r"&&(o===`
`?(n+=1,i=`
...
**\u8F6C\u6362\u540E\u7AEF** ${s}
                `,protocolOptions:[],noTemplate:!0}};return JSON.stringify(t)}function Ai(s){let e=s.get("Content-Disposition")||s.get("content-disposition");if(!e)return null;let t=e.match(/filename="?([^"]+)"?/);if(!t)return null;let n=t[1];if(!/[^\x00-\x7F]/.test(n))return e;let o="download.json",r=encodeURIComponent(n);return`attachment; filename="${o}"; filename*=UTF-8''${r}`}async function Vt(){let s=new Set,e=["https://github.com/mnixry/direct-android-ruleset/raw/refs/heads/rules/@Merged/GAME.mutated.yaml","https://github.com/mnixry/direct-android-ruleset/raw/refs/heads/rules/@Merged/APP.mutated.yaml"],t=["\u6D4F\u89C8\u5668"],n=new Set(["com.android.chrome","mark.via"]);for(let i of e){let o=await Y(i);if(!o||o===!0||o.status!==200){console.error(`\u274C \u8BF7\u6C42\u5931\u8D25: ${i}`);continue}let r=typeof o.data=="string"?o.data:JSON.stringify(o.data);for(let a of r.split(`
`)){let l=a.match(/PROCESS-NAME\s*,\s*([^\s,]+)/);if(l){let c=l[1];!t.some(u=>a.includes(u))&&!n.has(c)&&s.add(c)}}}return[...s]}async function Yt(){let s=["https://raw.githubusercontent.com/Kwisma/clash-rules/release/cncidr.yaml"],e=[];for(let t of s){let n=await Y(t);if(!n||n.status!==200){console.error(`\u274C \u8BF7\u6C42\u5931\u8D25: ${t} - ${n?.status}`);continue}let i=n.data;i&&Array.isArray(i.payload)&&e.push(...i.payload)}return e}async function ks(s){return s.urls.length===1?await Ni(s):await Li(s)}async function Ni(s){let e=await Pn(s.urls[0],s.userAgent,s.sub);return e?.data?.proxies&&Array.isArray(e.data.proxies)&&e.data.proxies.length>0?(Dn(e.data.proxies,s.udp),Oi(e,{providers:{}})):null}async function Li(s){let e={proxies:[],providers:{}},t=[];for(let o=0;o<s.urls.length;o++){let r=await Pn(s.urls[o],s.userAgent,s.sub);r?.data?.proxies&&Array.isArray(r.data.proxies)&&(Dn(r.data.proxies,s.udp,o+1),t.push({status:r.status,headers:r.headers}),e.proxies.push(...r.data.proxies))}if(t.length===0)return null;let n=Math.floor(Math.random()*t.length),i=t[n];return{status:i.status,headers:i.headers,data:e}}async function Pn(s,e,t){let n=await Y(s,e,!1);if(n?.data?.proxies&&Array.isArray(n.data.proxies)&&n.data.proxies.length>0)return n;let i=Ke(s,t,"clash.meta");return await Y(i,e,!1)}function Dn(s,e,t=null){s.forEach(n=>{t!==null&&(n.name=`${n.name} [${t}]`),e&&(n.udp=!0)})}function Oi(s,e={}){return{status:s.status,headers:s.headers,data:{...s.data,...e}}}async function Rn(s){if(!/meta|clash.meta|clash|clashverge|mihomo/i.test(s.userAgent))throw new Error("\u4E0D\u652F\u6301\u7684\u5BA2\u6237\u7AEF");s.urls=Ft(s.urls);let[e,t,n,i,o]=await Promise.all([Ut(s.Mihomo_default),Gt(s.rule),ks(s),s.exclude_package?Vt():null,s.exclude_address?Yt():null]);if(s.Exclude_Package=i,s.Exclude_Address=o,!n?.data?.proxies||n?.data?.proxies?.length===0)throw new Error("\u8282\u70B9\u4E3A\u7A7A");return t.data.proxies=[...t?.data?.proxies||[],...n?.data?.proxies],t.data["proxy-groups"]=Ci(n.data,t.data),t.data["proxy-providers"]=n?.data?.providers,Ei(e.data,t.data,s),{status:n.status,headers:n.headers,data:JSON.stringify(e.data,null,4)}}function Ei(s,e,t){s["proxy-providers"]=e["proxy-providers"]||{},s.proxies=e.proxies||[],s["proxy-groups"]=e["proxy-groups"]||[],s.rules=e.rules||[],s["sub-rules"]=e["sub-rules"]||{},s["rule-providers"]={...s["rule-providers"]||{},...e["rule-providers"]||{}};let n=e["proxy-groups"][0].name;s.dns.nameserver&&e["proxy-groups"][0].name&&(s.dns.nameserver=s.dns.nameserver.map(i=>typeof i=="string"?i.replace(/#PROXY/g,`#${n}`):i)),t.tun&&s.tun?s.tun.enable=!1:s.tun&&(t.exclude_address&&t.Exclude_Address&&(s.tun["route-address"]=["0.0.0.0/1","128.0.0.0/1","::/1","8000::/1"],s.tun["route-exclude-address"]=t.Exclude_Address||[]),t.exclude_package&&t.Exclude_Package&&(s.tun["include-package"]=[],s.tun["exclude-package"]=t.Exclude_Package||[])),t.adgdns&&(s.dns.nameserver=[`https://dns.adguard-dns.com/dns-query#${n}`],s.dns["nameserver-policy"]["RULE-SET:cn_domain"]=["quic://2026.dns1.top#DIRECT"])}function Ci(s,e){let t=[],n=e["proxy-groups"].filter(i=>{let o=!1,r=i.filter;if(typeof r!="string")return!0;let a=/\(\?i\)/i.test(r),l=r.replace(/\(\?i\)/gi,""),c;try{c=new RegExp(l,a?"i":"")}catch(p){return console.warn(`\u65E0\u6548\u7684\u6B63\u5219\u8868\u8FBE\u5F0F: ${r}`,p),!0}for(let p of s.proxies)if(c.test(p.name)){o=!0;break}return!o&&(!i.proxies||i.proxies.length===0)?(t.push(i.name),!1):!0});return n.forEach(i=>{i.proxies&&(i.proxies=i.proxies.filter(o=>!t.some(r=>r.includes(o))))}),n}async function xs(s){return s.urls.length===1?await Ii(s.urls[0],s):await Ti(s)}async function Ii(s,e){let t=await jn(s,e,!1);return t?.data?.outbounds?.length>0?(Kn(t.data.outbounds,e,0),Mi(t)):null}async function Ti(s){let e=[],t=[];for(let i=0;i<s.urls.length;i++){let o=await jn(s.urls[i],s,!0,i+1);o?.data?.outbounds?.length>0&&(Kn(o.data.outbounds,s,i+1),t.push(o),e.push(o.data.outbounds))}if(t.length===0)throw new Error("No valid outbounds found from any URL");let n=t[Math.floor(Math.random()*t.length)];return{status:n.status,headers:n.headers,data:{outbounds:e.flat()}}}async function jn(s,e,t,n=null){let i=await Y(s,e.userAgent,!1);if(Bn(i))return i;let o=Ke(s,e.sub,"singbox");return i=await Y(o,e.userAgent,!1),Bn(i)?i:null}function Bn(s){return s?.data?.outbounds&&Array.isArray(s.data.outbounds)}function Kn(s,e,t){s.forEach(n=>{t>0&&(n.tag=`${n.tag} [${t}]`),e.udp_fragment&&(n.udp_fragment=!0)})}function Mi(s){return{status:s.status,headers:s.headers,data:s.data}}async function qn(s){let e=$i(s);s.urls=Ft(s.urls);let[t,n,i,o,r]=await Promise.all([Ut(e),Gt(s.rule),xs(s),s.exclude_package?Vt():null,s.exclude_address?Yt():null]);if(s.Exclude_Package=o,s.Exclude_Address=r,!i?.data?.outbounds||i?.data?.outbounds?.length===0)throw new Error("\u8282\u70B9\u4E3A\u7A7A\uFF0C\u8BF7\u4F7F\u7528\u6709\u6548\u8BA2\u9605");i.data.outbounds=Pi(i.data);let a=[];return i.data.outbounds.forEach(l=>{a.push(l.tag)}),n.data.outbounds=Di(n.data.outbounds,a),n.data.outbounds.push(...i.data.outbounds),Ri(t.data,n.data,s),{status:i.status,headers:i.headers,data:JSON.stringify(t.data,null,4)}}function $i(s){let e,t=!1,n=s.userAgent.match(/1\.12\.0\-alpha\.(\d{1,2})\b/),i=s.userAgent.match(/1\.12\.0\-beta\.(\d{1,2})\b/),o=s.userAgent.match(/1\.11\.(\d+)/),r=s.userAgent.match(/1\.12\.(\d+)/),a=s.userAgent.match(/1\.13\.(\d+)/),l=s.userAgent.match(/1\.14\.(\d+)/);if(!/singbox|sing-box|sfa|sfm/i.test(s.userAgent))throw new Error("\u4E0D\u652F\u6301\u7684\u5BA2\u6237\u7AEF");if(n&&!t){let c=parseInt(n[1],10);c>=0&&c<=23&&(e=s.singbox_1_12_alpha,t=!0)}if(i&&!t){let c=parseInt(i[1],10);c>=0&&c<=9&&(e=s.singbox_1_11,s.tailscale=!1,s.tls_fragment=!1,t=!0)}if(o&&!t&&(e=s.singbox_1_11,s.tailscale=!1,s.tls_fragment=!1,t=!0),r&&!t&&(e=s.singbox_1_12,t=!0),a&&!t&&(e=s.singbox_1_13,t=!0),l&&!t&&(e=s.singbox_1_14,t=!0),!t)throw new Error(`\u4E0D\u652F\u6301\u7684 Singbox \u7248\u672C\uFF1A${s.userAgent}`);return e}function Pi(s){let e=["direct","block","dns","selector","urltest"];if(s&&Array.isArray(s.outbounds))return s.outbounds.filter(n=>!(e.includes(n.type)||n?.server===""||n?.server_port<1||n?.password===""))}function Di(s,e){let t=l=>{let c=[],p=!1;return l.filter?.forEach(u=>{if(u.action!=="all"&&(!u.keywords||typeof u.keywords!="string"))return;let f=[];if(u.action==="all")f=e,p=!0;else{let{pattern:h,ignoreCase:g}=n(u.keywords),d=new RegExp(h,g?"i":"");f=i(e,d,u.action),p=!0}f.length>0&&(c=[...c,...f])}),{matchedOutbounds:[...new Set(c)],hasValidAction:p}},n=l=>{if(!l||typeof l!="string")return{pattern:"^$",ignoreCase:!1};let c=/\(\?i\)/i.test(l);return{pattern:l.replace(/\(\?i\)/gi,""),ignoreCase:c}},i=(l,c,p)=>{switch(p){case"include":return l.filter(u=>c.test(u));case"exclude":return l.filter(u=>!c.test(u));default:return[]}},o=(l,c,p)=>(c.length>0?l.outbounds=l.outbounds?[...new Set([...l.outbounds,...c])]:c:l.outbounds&&l.outbounds.length>0||delete l.outbounds,delete l.filter,l),r=l=>{let c=l.filter(u=>!u.outbounds||Array.isArray(u.outbounds)&&u.outbounds.length===0).map(u=>u.tag).filter(u=>u!==void 0);return l.map(u=>(u.outbounds&&Array.isArray(u.outbounds)&&(u.outbounds=u.outbounds.filter(f=>!c.includes(f))),u)).filter(u=>u.outbounds&&Array.isArray(u.outbounds)&&u.outbounds.length>0)},a=s.map(l=>{let{matchedOutbounds:c,hasValidAction:p}=t(l);return o(l,c,p)});return r(a)}function Ri(s,e,t){let n=Array.isArray(s.route.rule_set)?s.route.rule_set:[],i=Array.isArray(e.route.rule_set)?e.route.rule_set:[],o=new Map;for(let r of n)r?.tag&&o.set(r.tag,r);for(let r of i)r?.tag&&o.set(r.tag,r);if(s.inbounds=e?.inbounds||s.inbounds,s.outbounds=[...Array.isArray(s.outbounds)?s.outbounds:[],...Array.isArray(e?.outbounds)?e.outbounds:[]],s.route.final=e?.route?.final||s.route.final,s.route.rules=[...Array.isArray(s.route.rules)?s.route.rules:[],...Array.isArray(e?.route?.rules)?e.route.rules:[]],s.route.rule_set=Array.from(o.values()),t.tun?s.inbounds=s.inbounds.filter(r=>r.type!=="tun"):(t.exclude_package&&Bi(s,t.Exclude_Package),t.exclude_address&&ji(s,t.Exclude_Address)),t.tailscale&&(s.dns.servers.push({type:"tailscale",endpoint:"ts-ep",accept_default_resolvers:!0}),s.endpoints=s.endpoints||[],s.endpoints.push({type:"tailscale",tag:"ts-ep",auth_key:"",hostname:"singbox-tailscale",udp_timeout:"5m"})),/ref1nd/i.test(t.userAgent))for(let r of s.route.rules)r.action==="resolve"&&(r.match_only=!0);s.route.rules=s.route.rules.flatMap(r=>r.action==="route-options"?(t.udp&&(r.udp_disable_domain_unmapping=!0,r.udp_connect=!0,r.udp_timeout="5m"),t.tls_fragment&&(r.tls_fragment=!0,r.tls_fragment_fallback_delay="5m"),t.udp||t.tls_fragment?r:[]):r),t.adgdns&&s.dns.servers.flatMap(r=>(r.tag==="DIRECT-DNS"&&(r={type:"quic",tag:"DIRECT-DNS",detour:"\u{1F3AF} \u5168\u7403\u76F4\u8FDE",server_port:853,server:"2026.dns1.top",domain_resolver:"local"}),r.tag==="PROXY-DNS"&&(r={type:"https",tag:"PROXY-DNS",detour:"\u{1F680} \u8282\u70B9\u9009\u62E9",server_port:443,server:"dns.adguard-dns.com",domain_resolver:"local"}),r))}function Bi(s,e){for(let t of s.inbounds)t.type==="tun"&&(Array.isArray(t.exclude_package)||(t.exclude_package=[]),t.exclude_package=Array.from(new Set([...t.exclude_package||[],...e])))}function ji(s,e){for(let t of s.inbounds)t.type==="tun"&&(t.route_address=["0.0.0.0/1","128.0.0.0/1","::/1","8000::/1"],Array.isArray(t.route_exclude_address)||(t.route_exclude_address=[]),t.route_exclude_address=Array.from(new Set([...t.route_exclude_address||[],...e])))}async function Fn(s){let e=Ke(s.urls.join(","),s.sub,"v2ray"),t=await Y(e,s.userAgent);if(t.data!==void 0&&t.data!==null&&t.data!=="")return{status:t.status,headers:t.headers,data:t.data};throw new Error("\u83B7\u53D6\u8BA2\u9605\u6570\u636E\u5931\u8D25\uFF0C\u8BF7\u68C0\u67E5\u8BA2\u9605\u94FE\u63A5\u662F\u5426\u6709\u6548")}var Ki=s=>`
        :root {
...
</html>`}async function qi(s,e){let t=new URL(s.url,`http://${s.headers.host}`),n={url:t,urls:t.searchParams.getAll("url"),userAgent:s.headers["user-agent"],rule:t.searchParams.get("template"),singbox:t.searchParams.get("singbox")==="true",mihomo:t.searchParams.get("mihomo")==="true",v2ray:t.searchParams.get("v2ray")==="true",udp:t.searchParams.get("udp")==="true",udp_fragment:t.searchParams.get("udp_frag")==="true",tls_fragment:t.searchParams.get("tls_frag")==="true",exclude_package:t.searchParams.get("ep")==="true",exclude_address:t.searchParams.get("ea")==="true",tailscale:t.searchParams.get("tailscale")==="true",adgdns:t.searchParams.get("adgdns")==="true",tun:t.searchParams.get("tun")==="true",IMG:process.env.IMG||vn,sub:process.env.SUB||_n,Mihomo_default:process.env.MIHOMOTOP||An,singbox_1_11:process.env.SINGBOX_1_11||Nn,singbox_1_12:process.env.SINGBOX_1_12||Ln,singbox_1_12_alpha:process.env.SINGBOX_1_12_ALPHA||On,singbox_1_13:process.env.SINGBOX_1_13||En,singbox_1_14:process.env.SINGBOX_1_14||Cn,beian:process.env.BEIAN||In,beianurl:process.env.BEIANURL||Tn,configs:Mn(process.env.MIHOMO,process.env.SINGBOX)};if(n.modes=$n(n.sub,n.userAgent),n.urls.length===1&&n.urls[0].includes(",")&&(n.urls=n.urls[0].split(",").map(i=>i.trim())),n.urls.length===0||n.urls[0]===""){let i=await Gn(n);e.setHeader("Content-Type","text/html; charset=utf-8"),e.statusCode=200,e.end(i);return}try{let i;n.singbox?i=await qn(n):n.mihomo?i=await Rn(n):n.v2ray&&(i=await Fn(n));let o=i.headers,r=["transfer-encoding","content-length","content-encoding","connection"];for(let[a,l]of Object.entries(o))r.includes(a.toLowerCase())||e.setHeader(a,l);e.setHeader("Content-Type","application/json; charset=utf-8"),e.setHeader("Profile-web-page-url",t.origin),e.statusCode=i.status||200,e.end(i.data)}catch(i){e.statusCode=400,e.setHeader("Content-Type","application/json; charset=utf-8"),e.end(JSON.stringify({error:i.message}))}}export{qi as default};
