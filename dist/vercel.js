...
`):x+=`
${t.indent}`}else if(!m&&_(e)){let E=v[0],b=v.indexOf(`
...
${t.indent}`)}}else(v===""||v[0]===`
`)&&(x="");return h+=x+v,t.inFlow?A&&n&&n():k&&!A?h+=se(h,t.indent,c(k)):p&&i&&i(),h}function ht(s,e){(s==="debug"||s==="warn")&&console.warn(e)}var mt="<<",W={identify:s=>s===mt||typeof s=="symbol"&&s.description===mt,default:"key",tag:"tag:yaml.org,2002:merge",test:/^<<$/,resolve:()=>Object.assign(new y(Symbol(mt)),{addToJSMap:zt}),stringify:()=>mt},_s=(s,e)=>(W.identify(e)||N(e)&&(!e.type||e.type===y.PLAIN)&&W.identify(e.value))&&s?.doc.schema.tags.some(t=>t.tag===W.tag&&t.default);function zt(s,e,t){if(t=s&&K(t)?t.resolve(s.doc):t,G(t))for(let n of t.items)Wt(s,e,n);else if(Array.isArray(t))for(let n of t)Wt(s,e,n);else Wt(s,e,t)}function Wt(s,e,t){let n=s&&K(t)?t.resolve(s.doc):t;if(!U(n))throw new Error("Merge sources must be maps or map aliases");let i=n.toJSON(null,s,Map);for(let[o,r]of i)e instanceof Map?e.has(o)||e.set(o,r):e instanceof Set?e.add(o):Object.prototype.hasOwnProperty.call(e,o)||Object.defineProperty(e,o,{value:r,writable:!0,enumerable:!0,configurable:!0});return e}function gt(s,e,{key:t,value:n}){if(O(t)&&t.addToJSMap)t.addToJSMap(s,e,n);else if(_s(s,t))zt(s,e,n);else{let i=$(t,"",s);if(e instanceof Map)e.set(i,$(n,i,s));else if(e instanceof Set)e.add(i);else{let o=Rn(t,i,s),r=$(n,o,s);o in e?Object.defineProperty(e,o,{value:r,writable:!0,enumerable:!0,configurable:!0}):e[o]=r}}return e}function Rn(s,e,t){if(e===null)return"";if(typeof e!="object")return String(e);if(O(s)&&t?.doc){let n=dt(t.doc,{});n.anchors=new Set;for(let o of t.anchors.keys())n.anchors.add(o.anchor);n.inFlow=!0,n.inStringifyKey=!0;let i=s.toString(n);if(!t.mapKeyWarned){let o=JSON.stringify(i);o.length>40&&(o=o.substring(0,36)+'..."'),ht(t.doc.options.logLevel,`Keys with collection values will be stringified due to JS Object restrictions: ${o}. Set mapAsMap: true to use object keys.`),t.mapKeyWarned=!0}return i}return JSON.stringify(e)}function Oe(s,e,t){let n=ae(s,void 0,t),i=ae(e,void 0,t);return new C(n,i)}var C=class s{constructor(e,t=null){Object.defineProperty(this,B,{value:Ut}),this.key=e,this.value=t}clone(e){let{key:t,value:n}=this;return O(t)&&(t=t.clone(e)),O(n)&&(n=n.clone(e)),new s(t,n)}toJSON(e,t){let n=t?.mapAsMap?new Map:{};return gt(t,n,this)}toString(e,t,n){return e?.doc?Os(this,e,t,n):JSON.stringify(this)}};function bt(s,e,t){return(e.inFlow??s.flow?qn:Kn)(s,e,t)}function Kn({comment:s,items:e},t,{blockItemPrefix:n,flowChars:i,itemIndent:o,onChompKeep:r,onComment:a}){let{indent:l,options:{commentString:c}}=t,d=Object.assign({},t,{indent:o,type:null}),f=!1,u=[];for(let g=0;g<e.length;++g){let p=e[g],h=null;if(O(p))!f&&p.spaceBefore&&u.push(""),yt(t,u,p.commentBefore,f),p.comment&&(h=p.comment);else if(L(p)){let S=O(p.key)?p.key:null;S&&(!f&&S.spaceBefore&&u.push(""),yt(t,u,S.commentBefore,f))}f=!1;let w=ce(p,d,()=>h=null,()=>f=!0);h&&(w+=se(w,o,c(h))),f&&h&&(f=!1),u.push(n+w)}let m;if(u.length===0)m=i.start+i.end;else{m=u[0];for(let g=1;g<u.length;++g){let p=u[g];m+=p?`
${l}${p}`:`
`}}return s?(m+=`
`+V(c(s),l),a&&a()):f&&r&&r(),m}function qn({items:s},e,{flowChars:t,itemIndent:n}){let{indent:i,indentStep:o,flowCollectionPadding:r,options:{commentString:a}}=e;n+=o;let l=Object.assign({},e,{indent:n,inFlow:!0,type:null}),c=!1,d=0,f=[];for(let g=0;g<s.length;++g){let p=s[g],h=null;if(O(p))p.spaceBefore&&f.push(""),yt(e,f,p.commentBefore,!1),p.comment&&(h=p.comment);else if(L(p)){let S=O(p.key)?p.key:null;S&&(S.spaceBefore&&f.push(""),yt(e,f,S.commentBefore,!1),S.comment&&(c=!0));let k=O(p.value)?p.value:null;k?(k.comment&&(h=k.comment),k.commentBefore&&(c=!0)):p.value==null&&S?.comment&&(h=S.comment)}h&&(c=!0);let w=ce(p,l,()=>h=null);g<s.length-1&&(w+=","),h&&(w+=se(w,n,a(h))),!c&&(f.length>d||w.includes(`
...
${n}`:n;else if(i||e.directives.docStart||!o)e.commentBefore=n;else if(_(o)&&!o.flow&&o.items.length>0){let r=o.items[0];L(r)&&(r=r.key);let a=r.commentBefore;r.commentBefore=a?`${n}
...
`:case"\r":case"	":return!0;default:return!1}}var cn=new Set("0123456789ABCDEFabcdef"),li=new Set("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-#;/?:@&=+$_.!~*'()"),jt=new Set(",[]{}"),ci=new Set(` ,[]{}
...
`&&o>=this.pos&&o+1+t>a)e=o;else break}while(!0);return yield Pe,yield*this.pushToIndex(e+1,!0),yield*this.parseLineStart()}*parsePlainScalar(){let e=this.flowLevel>0,t=this.pos-1,n=this.pos-1,i;for(;i=this.buffer[++n];)if(i===":"){let o=this.buffer[n+1];if(X(o)||e&&jt.has(o))break;t=n}else if(X(i)){let o=this.buffer[n+1];if(i==="\r"&&(o===`
`?(n+=1,i=`
