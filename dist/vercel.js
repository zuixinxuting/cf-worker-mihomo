...
${t.comment}`:t.comment}this.doc.range[2]=t.offset;break}default:this.errors.push(new q(tt(e),"UNEXPECTED_TOKEN",`Unsupported token ${e.type}`))}}*end(e=!1,t=-1){if(this.doc)this.decorate(this.doc,!0),yield this.doc,this.doc=null;else if(e){let n=Object.assign({_directives:this.directives},this.options),i=new se(void 0,n);this.atDirectives&&this.onError(t,"MISSING_CHAR","Missing directives-end indicator line"),i.range=[0,t,t],this.decorate(i,!1),yield i}}};var ys={};_s(ys,{BOM:()=>st,DOCUMENT:()=>nt,FLOW_END:()=>it,SCALAR:()=>De,createScalarToken:()=>cn,isCollection:()=>Si,isScalar:()=>ki,prettyToken:()=>xi,resolveAsScalar:()=>ln,setScalarValue:()=>un,stringify:()=>dn,tokenType:()=>gs,visit:()=>ye});function ln(s,e=!0,t){if(s){let n=(i,o,r)=>{let a=typeof i=="number"?i:Array.isArray(i)?i[0]:i.offset;if(t)t(a,o,r);else throw new q([a,a+1],o,r)};switch(s.type){case"scalar":case"single-quoted-scalar":case"double-quoted-scalar":return Dt(s,e,n);case"block-scalar":return Pt({options:{strict:e}},s,n)}}return null}function cn(s,e){let{implicitKey:t=!1,indent:n,inFlow:i=!1,offset:o=-1,type:r="PLAIN"}=e,a=ce({type:r,value:s},{implicitKey:t,indent:n>0?" ".repeat(n):"",inFlow:i,options:{blockQuote:!0,lineWidth:-1}}),l=e.end??[{type:"newline",offset:-1,indent:n,source:`
