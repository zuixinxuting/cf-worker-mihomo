...
`);g===-1?f="-":t===h||g!==h.length-1?(f="+",o&&o()):f="",h&&(t=t.slice(0,-h.length),h[h.length-1]===`
...
$&`).replace(/(?:^|\n)([\t ].*)(?:([\n\t ]*)\n(?![\n\t ]))?/g,"$1$2").replace(/\n+/g,`$&${c}`),A=!1,E=pt(n,!0);r!=="folded"&&e!==y.BLOCK_FOLDED&&(E.onOverflow=()=>{A=!0});let b=Ve(`${S}${v}${h}`,c,ut,E);if(!A)return`>${x}
...
`))return dt(s,e,t,n);if(mt(o)){if(l==="")return e.forceBlockIndent=!0,dt(s,e,t,n);if(a&&l===c)return Le(o,e)}let f=o.replace(/\n+/g,`$&
${l}`);if(r){let u=d=>d.default&&d.tag!=="tag:yaml.org,2002:str"&&d.test?.test(f),{compat:h,tags:g}=e.doc.schema;if(g.some(u)||h?.some(u))return Le(o,e)}return a?f:Ve(f,l,zt,pt(e,!1))}function ce(s,e,t,n){let{implicitKey:i,inFlow:o}=e,r=typeof s.value=="string"?s:Object.assign({},s,{value:String(s.value)}),{type:a}=s;a!==y.QUOTE_DOUBLE&&/[\x00-\x08\x0b-\x1f\x7f-\x9f\u{D800}-\u{DFFF}]/u.test(r.value)&&(a=y.QUOTE_DOUBLE);let l=p=>{switch(p){case y.BLOCK_FOLDED:case y.BLOCK_LITERAL:return i||o?Le(r.value,e):dt(r,e,t,n);case y.QUOTE_DOUBLE:return Ye(r.value,e);case y.QUOTE_SINGLE:return Xt(r.value,e);case y.PLAIN:return Qn(r,e,t,n);default:return null}},c=l(a);if(c===null){let{defaultKeyType:p,defaultStringType:f}=e.options,u=i&&p||f;if(c=l(u),c===null)throw new Error(`Unsupported default string type ${u}`)}return c}function ht(s,e){let t=Object.assign({blockQuote:!0,commentString:Ts,defaultKeyType:null,defaultStringType:"PLAIN",directives:null,doubleQuotedAsJSON:!1,doubleQuotedMinMultiLineLength:40,falseStr:"false",flowCollectionPadding:!0,indentSeq:!0,lineWidth:80,minContentWidth:20,nullStr:"null",simpleKeys:!1,singleQuote:null,trueStr:"true",verifyAliasOrder:!0},s.schema.toStringOptions,e),n;switch(t.collectionStyle){case"block":n=!1;break;case"flow":n=!0;break;default:n=null}return{anchors:new Set,doc:s,flowCollectionPadding:t.flowCollectionPadding?" ":"",indent:"",indentStep:typeof t.indent=="number"?" ".repeat(t.indent):"  ",inFlow:n,options:t}}function Zn(s,e){if(e.tag){let i=s.filter(o=>o.tag===e.tag);if(i.length>0)return i.find(o=>o.format===e.format)??i[0]}let t,n;if(_(e)){n=e.value;let i=s.filter(o=>o.identify?.(n));if(i.length>1){let o=i.filter(r=>r.test);o.length>0&&(i=o)}t=i.find(o=>o.format===e.format)??i.find(o=>!o.format)}else n=e,t=s.find(i=>i.nodeClass&&n instanceof i.nodeClass);if(!t){let i=n?.constructor?.name??(n===null?"null":typeof n);throw new Error(`Tag not resolved for ${i} value`)}return t}function ei(s,e,{anchors:t,doc:n}){if(!n.directives)return"";let i=[],o=(_(s)||O(s))&&s.anchor;o&&lt(o)&&(t.add(o),i.push(`&${o}`));let r=s.tag??(e.default?null:e.tag);return r&&i.push(n.directives.tagString(r)),i.join(" ")}function fe(s,e,t,n){if(N(s))return s.toString(e,t,n);if(K(s)){if(e.doc.directives)return s.toString(e);if(e.resolvedAliases?.has(s))throw new TypeError("Cannot stringify circular structure without alias nodes");e.resolvedAliases?e.resolvedAliases.add(s):e.resolvedAliases=new Set([s]),s=s.resolve(e.doc)}let i,o=L(s)?s:e.doc.createNode(s,{onTagObj:l=>i=l});i??(i=Zn(e.doc.schema.tags,o));let r=ei(o,i,e);r.length>0&&(e.indentAtStart=(e.indentAtStart??0)+r.length+1);let a=typeof i.stringify=="function"?i.stringify(o,e,t,n):_(o)?ce(o,e,t,n):o.toString(e,t,n);return r?_(o)||a[0]==="{"||a[0]==="["?`${r} ${a}`:`${r}
${e.indent}${a}`:a}function $s({key:s,value:e},t,n,i){let{allNullValues:o,doc:r,indent:a,indentStep:l,options:{commentString:c,indentSeq:p,simpleKeys:f}}=t,u=L(s)&&s.comment||null;if(f){if(u)throw new Error("With simple keys, key nodes cannot have comments");if(O(s)||!L(s)&&typeof s=="object"){let E="With simple keys, collection cannot be used as a key value";throw new Error(E)}}let h=!f&&(!s||u&&e==null&&!t.inFlow||O(s)||(_(s)?s.type===y.BLOCK_FOLDED||s.type===y.BLOCK_LITERAL:typeof s=="object"));t=Object.assign({},t,{allNullValues:!1,implicitKey:!h&&(f||!o),indent:a+l});let g=!1,d=!1,m=fe(s,t,()=>g=!0,()=>d=!0);if(!h&&!t.inFlow&&m.length>1024){if(f)throw new Error("With simple keys, single line scalar must not span more than 1024 characters");h=!0}if(t.inFlow){if(o||e==null)return g&&n&&n(),m===""?"?":h?`? ${m}`:m}else if(o&&!f||e==null&&h)return m=`? ${m}`,u&&!g?m+=se(m,t.indent,c(u)):d&&i&&i(),m;g&&(u=null),h?(u&&(m+=se(m,t.indent,c(u))),m=`? ${m}
${a}:`):(m=`${m}:`,u&&(m+=se(m,t.indent,c(u))));let w,S,k;L(e)?(w=!!e.spaceBefore,S=e.commentBefore,k=e.comment):(w=!1,S=null,k=null,e&&typeof e=="object"&&(e=r.createNode(e))),t.implicitKey=!1,!h&&!u&&_(e)&&(t.indentAtStart=m.length+1),d=!1,!p&&l.length>=2&&!t.inFlow&&!h&&G(e)&&!e.flow&&!e.tag&&!e.anchor&&(t.indent=t.indent.substring(2));let x=!1,v=fe(e,t,()=>x=!0,()=>d=!0),A=" ";if(u||w||S){if(A=w?`
`:"",S){let E=c(S);A+=`
...
`+E:b.comment=E,A.comment=A.comment.substring(E.length+1)}}if(!r&&!x&&!A.found){let E=v?s(t,v,A,i):e(t,A.end,x,null,A,i);c.items.push(E),f=E.range[2],fs(v)&&i(E.range,"BLOCK_IN_FLOW",cs)}else{t.atKey=!0;let E=A.end,b=k?s(t,k,A,i):e(t,E,S,null,A,i);fs(k)&&i(b.range,"BLOCK_IN_FLOW",cs),t.atKey=!1;let T=ie(x??[],{flow:a,indicator:"map-value-ind",next:v,offset:b.range[2],onError:i,parentIndent:n.indent,startOnNewline:!1});if(T.found){if(!r&&!A.found&&t.options.strict){if(x)for(let M of x){if(M===T.found)break;if(M.type==="newline"){i(M,"MULTILINE_IMPLICIT_KEY","Implicit keys of flow sequence pairs need to be on a single line");break}}A.start<T.found.offset-1024&&i(T.found,"KEY_OVER_1024_CHARS","The : indicator must be at most 1024 chars after the start of an implicit flow sequence key")}}else v&&("source"in v&&v.source&&v.source[0]===":"?i(v,"MISSING_CHAR",`Missing space after : in ${a}`):i(T.start,"MISSING_CHAR",`Missing , or : between ${a} items`));let ue=v?s(t,v,T,i):T.found?e(t,T.end,x,null,T,i):null;ue?fs(v)&&i(ue.range,"BLOCK_IN_FLOW",cs):T.comment&&(b.comment?b.comment+=`
`+T.comment:b.comment=T.comment);let xe=new C(b,ue);if(t.options.keepSourceTokens&&(xe.srcToken=w),r){let M=c;$t(t,M.items,b)&&i(E,"DUPLICATE_KEY","Map keys must be unique"),M.items.push(xe)}else{let M=new I(t.schema);M.flow=!0,M.items.push(xe);let _s=(ue??b).range;M.range=[b.range[0],_s[1],_s[2]],c.items.push(M)}f=ue?ue.range[2]:T.end}}let u=r?"}":"]",[h,...g]=n.end,d=f;if(h&&h.source===u)d=h.offset+h.source.length;else{let m=a[0].toUpperCase()+a.substring(1),w=p?`${m} must end with a ${u}`:`${m} in block collection must be sufficiently indented and end with a ${u}`;i(f,p?"MISSING_CHAR":"BAD_INDENT",w),h&&h.source.length!==1&&g.unshift(h)}if(g.length>0){let m=oe(g,d,t.options.strict,i);m.comment&&(c.comment?c.comment+=`
`+m.comment:c.comment=m.comment),c.range=[n.offset,d,m.offset]}else c.range=[n.offset,d,d];return c}function us(s,e,t,n,i,o){let r=t.type==="block-map"?en(s,e,t,n,o):t.type==="block-seq"?tn(s,e,t,n,o):sn(s,e,t,n,o),a=r.constructor;return i==="!"||i===a.tagName?(r.tag=a.tagName,r):(i&&(r.tag=i),r)}function nn(s,e,t,n,i){let o=n.tag,r=o?e.directives.tagName(o.source,u=>i(o,"TAG_RESOLVE_FAILED",u)):null;if(t.type==="block-seq"){let{anchor:u,newlineAfterProp:h}=n,g=u&&o?u.offset>o.offset?u:o:u??o;g&&(!h||h.offset<g.offset)&&i(g,"MISSING_CHAR","Missing newline after block sequence props")}let a=t.type==="block-map"?"map":t.type==="block-seq"?"seq":t.start.source==="{"?"map":"seq";if(!o||!r||r==="!"||r===I.tagName&&a==="map"||r===P.tagName&&a==="seq")return us(s,e,t,i,r);let l=e.schema.tags.find(u=>u.tag===r&&u.collection===a);if(!l){let u=e.schema.knownTags[r];if(u&&u.collection===a)e.schema.tags.push(Object.assign({},u,{default:!1})),l=u;else return u?i(o,"BAD_COLLECTION_TYPE",`${u.tag} used for ${a} collection, but expects ${u.collection??"scalar"}`,!0):i(o,"TAG_RESOLVE_FAILED",`Unresolved tag: ${r}`,!0),us(s,e,t,i,r)}let c=us(s,e,t,i,r,l),p=l.resolve?.(c,u=>i(o,"TAG_RESOLVE_FAILED",u),e.options)??c,f=L(p)?p:new y(p);return f.range=c.range,f.tag=r,l?.format&&(f.format=l.format),f}function Pt(s,e,t){let n=e.offset,i=ai(e,s.options.strict,t);if(!i)return{value:"",type:null,comment:"",range:[n,n,n]};let o=i.mode===">"?y.BLOCK_FOLDED:y.BLOCK_LITERAL,r=e.source?li(e.source):[],a=r.length;for(let d=r.length-1;d>=0;--d){let m=r[d][1];if(m===""||m==="\r")a=d;else break}if(a===0){let d=i.chomp==="+"&&r.length>0?`
`.repeat(Math.max(1,r.length-1)):"",m=n+i.length;return e.source&&(m+=e.source.length),{value:d,type:o,comment:i.comment,range:[n,m,m]}}let l=e.indent+i.indent,c=e.offset+i.length,p=0;for(let d=0;d<a;++d){let[m,w]=r[d];if(w===""||w==="\r")i.indent===0&&m.length>l&&(l=m.length);else{m.length<l&&t(c+m.length,"MISSING_CHAR","Block scalars with more-indented leading empty lines must use an explicit indentation indicator"),i.indent===0&&(l=m.length),p=d,l===0&&!s.atRoot&&t(c,"BAD_INDENT","Block scalar values in collections must be indented");break}c+=m.length+w.length+1}for(let d=r.length-1;d>=a;--d)r[d][0].length>l&&(a=d+1);let f="",u="",h=!1;for(let d=0;d<p;++d)f+=r[d][0].slice(l)+`
`;for(let d=p;d<a;++d){let[m,w]=r[d];c+=m.length+w.length+1;let S=w[w.length-1]==="\r";if(S&&(w=w.slice(0,-1)),w&&m.length<l){let x=`Block scalar lines must not be less indented than their ${i.indent?"explicit indentation indicator":"first line"}`;t(c-w.length-(S?2:1),"BAD_INDENT",x),m=""}o===y.BLOCK_LITERAL?(f+=u+m.slice(l)+w,u=`
`):m.length>l||w[0]==="	"?(u===" "?u=`
`:!h&&u===`
`&&(u=`
...
`?f+=`
`:u=`
`:(f+=u+w,u=" ",h=!1)}switch(i.chomp){case"-":break;case"+":for(let d=a;d<r.length;++d)f+=`
`+r[d][0].slice(l);f[f.length-1]!==`
`&&(f+=`
`);break;default:f+=`
`}let g=n+i.length+e.source.length;return{value:f,type:o,comment:i.comment,range:[n,g,g]}}function ai({offset:s,props:e},t,n){if(e[0].type!=="block-scalar-header")return n(e[0],"IMPOSSIBLE","Block scalar header not found"),null;let{source:i}=e[0],o=i[0],r=0,a="",l=-1;for(let u=1;u<i.length;++u){let h=i[u];if(!a&&(h==="-"||h==="+"))a=h;else{let g=Number(h);!r&&g?r=g:l===-1&&(l=s+u)}}l!==-1&&n(l,"UNEXPECTED_TOKEN",`Block scalar header includes extra characters: ${i}`);let c=!1,p="",f=i.length;for(let u=1;u<e.length;++u){let h=e[u];switch(h.type){case"space":c=!0;case"newline":f+=h.source.length;break;case"comment":t&&!c&&n(h,"MISSING_CHAR","Comments must be separated from other tokens by white space characters"),f+=h.source.length,p=h.source.substring(1);break;case"error":n(h,"UNEXPECTED_TOKEN",h.message),f+=h.source.length;break;default:{let g=`Unexpected token in block scalar header: ${h.type}`;n(h,"UNEXPECTED_TOKEN",g);let d=h.source;d&&typeof d=="string"&&(f+=d.length)}}}return{mode:o,indent:r,chomp:a,comment:p,length:f}}function li(s){let e=s.split(/\n( *)/),t=e[0],n=t.match(/^( *)/),o=[n?.[1]?[n[1],t.slice(n[1].length)]:["",t]];for(let r=1;r<e.length;r+=2)o.push([e[r],e[r+1]]);return o}function Dt(s,e,t){let{offset:n,type:i,source:o,end:r}=s,a,l,c=(u,h,g)=>t(n+u,h,g);switch(i){case"scalar":a=y.PLAIN,l=ci(o,c);break;case"single-quoted-scalar":a=y.QUOTE_SINGLE,l=fi(o,c);break;case"double-quoted-scalar":a=y.QUOTE_DOUBLE,l=ui(o,c);break;default:return t(s,"UNEXPECTED_TOKEN",`Expected a flow scalar value, but found: ${i}`),{value:"",type:null,comment:"",range:[n,n+o.length,n+o.length]}}let p=n+o.length,f=oe(r,p,e,t);return{value:l,type:a,comment:f.comment,range:[n,p,f.offset]}}function ci(s,e){let t="";switch(s[0]){case"	":t="a tab character";break;case",":t="flow indicator character ,";break;case"%":t="directive indicator character %";break;case"|":case">":{t=`block scalar indicator ${s[0]}`;break}case"@":case"`":{t=`reserved character ${s[0]}`;break}}return t&&e(0,"BAD_SCALAR_START",`Plain value cannot start with ${t}`),on(s)}function fi(s,e){return(s[s.length-1]!=="'"||s.length===1)&&e(s.length,"MISSING_CHAR","Missing closing 'quote"),on(s.slice(1,-1)).replace(/''/g,"'")}function on(s){let e,t;try{e=new RegExp(`(.*?)(?<![ 	])[ 	]*\r?
`,"sy"),t=new RegExp(`[ 	]*(.*?)(?:(?<![ 	])[ 	]*)?\r?
...
`:case"\r":case"	":return!0;default:return!1}}var gn=new Set("0123456789ABCDEFabcdef"),Ai=new Set("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-#;/?:@&=+$_.!~*'()"),Kt=new Set(",[]{}"),_i=new Set(` ,[]{}
