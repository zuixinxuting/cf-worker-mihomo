...
${e}${s.slice(x+1,v)}`)}return S}function Ms(s,e,t){let n=e,i=e+1,o=s[i];for(;o===" "||o==="	";)if(e<i+t)o=s[++e];else{do o=s[++e];while(o&&o!==`
`);n=e,i=e+1,o=s[i]}return n}var pt=(s,e)=>({indentAtStart:e?s.indent.length:s.indentAtStart,lineWidth:s.options.lineWidth,minContentWidth:s.options.minContentWidth}),mt=s=>/^(%|---|\.\.\.)/m.test(s);function Xn(s,e,t){if(!e||e<0)return!1;let n=e-t,i=s.length;if(i<=n)return!1;for(let o=0,r=0;o<i;++o)if(s[o]===`
...
+(?!
|$)`,"g")}catch{Qt=/\n+(?!\n|$)/g}function dt({comment:s,type:e,value:t},n,i,o){let{blockQuote:r,commentString:a,lineWidth:l}=n.options;if(!r||/\n[\t ]+$/.test(t))return Le(t,n);let c=n.indent||(n.forceBlockIndent||mt(t)?"  ":""),p=r==="literal"?!0:r==="folded"||e===y.BLOCK_FOLDED?!1:e===y.BLOCK_LITERAL?!0:!Xn(t,l,c.length);if(!t)return p?`|
`:`>
...
${c}${S}${t}${h}`}function Qn(s,e,t,n){let{type:i,value:o}=s,{actualString:r,implicitKey:a,indent:l,indentStep:c,inFlow:p}=e;if(a&&o.includes(`
...
`&&(u+=`
`);break;default:u+=`
`}let g=n+i.length+e.source.length;return{value:u,type:o,comment:i.comment,range:[n,g,g]}}function ai({offset:s,props:e},t,n){if(e[0].type!=="block-scalar-header")return n(e[0],"IMPOSSIBLE","Block scalar header not found"),null;let{source:i}=e[0],o=i[0],r=0,a="",l=-1;for(let f=1;f<i.length;++f){let h=i[f];if(!a&&(h==="-"||h==="+"))a=h;else{let g=Number(h);!r&&g?r=g:l===-1&&(l=s+f)}}l!==-1&&n(l,"UNEXPECTED_TOKEN",`Block scalar header includes extra characters: ${i}`);let c=!1,p="",u=i.length;for(let f=1;f<e.length;++f){let h=e[f];switch(h.type){case"space":c=!0;case"newline":u+=h.source.length;break;case"comment":t&&!c&&n(h,"MISSING_CHAR","Comments must be separated from other tokens by white space characters"),u+=h.source.length,p=h.source.substring(1);break;case"error":n(h,"UNEXPECTED_TOKEN",h.message),u+=h.source.length;break;default:{let g=`Unexpected token in block scalar header: ${h.type}`;n(h,"UNEXPECTED_TOKEN",g);let d=h.source;d&&typeof d=="string"&&(u+=d.length)}}}return{mode:o,indent:r,chomp:a,comment:p,length:u}}function li(s){let e=s.split(/\n( *)/),t=e[0],n=t.match(/^( *)/),o=[n?.[1]?[n[1],t.slice(n[1].length)]:["",t]];for(let r=1;r<e.length;r+=2)o.push([e[r],e[r+1]]);return o}function Dt(s,e,t){let{offset:n,type:i,source:o,end:r}=s,a,l,c=(f,h,g)=>t(n+f,h,g);switch(i){case"scalar":a=y.PLAIN,l=ci(o,c);break;case"single-quoted-scalar":a=y.QUOTE_SINGLE,l=ui(o,c);break;case"double-quoted-scalar":a=y.QUOTE_DOUBLE,l=fi(o,c);break;default:return t(s,"UNEXPECTED_TOKEN",`Expected a flow scalar value, but found: ${i}`),{value:"",type:null,comment:"",range:[n,n+o.length,n+o.length]}}let p=n+o.length,u=oe(r,p,e,t);return{value:l,type:a,comment:u.comment,range:[n,p,u.offset]}}function ci(s,e){let t="";switch(s[0]){case"	":t="a tab character";break;case",":t="flow indicator character ,";break;case"%":t="directive indicator character %";break;case"|":case">":{t=`block scalar indicator ${s[0]}`;break}case"@":case"`":{t=`reserved character ${s[0]}`;break}}return t&&e(0,"BAD_SCALAR_START",`Plain value cannot start with ${t}`),on(s)}function ui(s,e){return(s[s.length-1]!=="'"||s.length===1)&&e(s.length,"MISSING_CHAR","Missing closing 'quote"),on(s.slice(1,-1)).replace(/''/g,"'")}function on(s){let e,t;try{e=new RegExp(`(.*?)(?<![ 	])[ 	]*\r?
`,"sy"),t=new RegExp(`[ 	]*(.*?)(?:(?<![ 	])[ 	]*)?\r?
`,"sy")}catch{e=/(.*?)[ \t]*\r?\n/sy,t=/[ \t]*(.*?)[ \t]*\r?\n/sy}let n=e.exec(s);if(!n)return s;let i=n[1],o=" ",r=e.lastIndex;for(t.lastIndex=r;n=t.exec(s);)n[1]===""?o===`
`?i+=o:o=`
`:(i+=o+n[1],o=" "),r=t.lastIndex;let a=/[ \t]*(.*)/sy;return a.lastIndex=r,n=a.exec(s),i+o+(n?.[1]??"")}function fi(s,e){let t="";for(let n=1;n<s.length-1;++n){let i=s[n];if(!(i==="\r"&&s[n+1]===`
`))if(i===`
`){let{fold:o,offset:r}=di(s,n);t+=o,n=r}else if(i==="\\"){let o=s[++n],r=pi[o];if(r)t+=r;else if(o===`
`)for(o=s[n+1];o===" "||o==="	";)o=s[++n+1];else if(o==="\r"&&s[n+1]===`
`)for(o=s[++n+1];o===" "||o==="	";)o=s[++n+1];else if(o==="x"||o==="u"||o==="U"){let a={x:2,u:4,U:8}[o];t+=mi(s,n+1,a,e),n+=a}else{let a=s.substr(n-1,2);e(n-1,"BAD_DQ_ESCAPE",`Invalid escape sequence ${a}`),t+=a}}else if(i===" "||i==="	"){let o=n,r=s[n+1];for(;r===" "||r==="	";)r=s[++n+1];r!==`
`&&!(r==="\r"&&s[n+2]===`
`)&&(t+=n>o?s.slice(o,n+1):i)}else t+=i}return(s[s.length-1]!=='"'||s.length===1)&&e(s.length,"MISSING_CHAR",'Missing closing "quote'),t}function di(s,e){let t="",n=s[e+1];for(;(n===" "||n==="	"||n===`
`||n==="\r")&&!(n==="\r"&&s[e+2]!==`
`);)n===`
`&&(t+=`
`),e+=1,n=s[e+1];return t||(t=" "),{fold:t,offset:e}}var pi={0:"\0",a:"\x07",b:"\b",e:"\x1B",f:"\f",n:`
`,r:"\r",t:"	",v:"\v",N:"\x85",_:"\xA0",L:"\u2028",P:"\u2029"," ":" ",'"':'"',"/":"/","\\":"\\","	":"	"};function mi(s,e,t,n){let i=s.substr(e,t),r=i.length===t&&/^[0-9a-fA-F]+$/.test(i)?parseInt(i,16):NaN;if(isNaN(r)){let a=s.substr(e-2,t+2);return n(e-2,"BAD_DQ_ESCAPE",`Invalid escape sequence ${a}`),a}return String.fromCodePoint(r)}function ds(s,e,t,n){let{value:i,type:o,comment:r,range:a}=e.type==="block-scalar"?Pt(s,e,n):Dt(e,s.options.strict,n),l=t?s.directives.tagName(t.source,u=>n(t,"TAG_RESOLVE_FAILED",u)):null,c;s.options.stringKeys&&s.atKey?c=s.schema[j]:l?c=hi(s.schema,i,l,t,n):e.type==="scalar"?c=gi(s,i,e,n):c=s.schema[j];let p;try{let u=c.resolve(i,f=>n(t??e,"TAG_RESOLVE_FAILED",f),s.options);p=A(u)?u:new y(u)}catch(u){let f=u instanceof Error?u.message:String(u);n(t??e,"TAG_RESOLVE_FAILED",f),p=new y(i)}return p.range=a,p.source=i,o&&(p.type=o),l&&(p.tag=l),c.format&&(p.format=c.format),r&&(p.comment=r),p}function hi(s,e,t,n,i){if(t==="!")return s[j];let o=[];for(let a of s.tags)if(!a.collection&&a.tag===t)if(a.default&&a.test)o.push(a);else return a;for(let a of o)if(a.test?.test(e))return a;let r=s.knownTags[t];return r&&!r.collection?(s.tags.push(Object.assign({},r,{default:!1,test:void 0})),r):(i(n,"TAG_RESOLVE_FAILED",`Unresolved tag: ${t}`,t!=="tag:yaml.org,2002:str"),s[j])}function gi({atKey:s,directives:e,schema:t},n,i,o){let r=t.tags.find(a=>(a.default===!0||s&&a.default==="key")&&a.test?.test(n))||t[j];if(t.compat){let a=t.compat.find(l=>l.default&&l.test?.test(n))??t[j];if(r.tag!==a.tag){let l=e.tagString(r.tag),c=e.tagString(a.tag),p=`Value may be parsed as either ${l} or ${c}`;o(i,"TAG_RESOLVE_FAILED",p,!0)}}return r}function rn(s,e,t){if(e){t??(t=e.length);for(let n=t-1;n>=0;--n){let i=e[n];switch(i.type){case"space":case"comment":case"newline":s-=i.source.length;continue}for(i=e[++n];i?.type==="space";)s+=i.source.length,i=e[++n];break}}return s}var yi={composeNode:ps,composeEmptyNode:Rt};function ps(s,e,t,n){let i=s.atKey,{spaceBefore:o,comment:r,anchor:a,tag:l}=t,c,p=!0;switch(e.type){case"alias":c=bi(s,e,n),(a||l)&&n(e,"ALIAS_PROPS","An alias node must not specify any properties");break;case"scalar":case"single-quoted-scalar":case"double-quoted-scalar":case"block-scalar":c=ds(s,e,l,n),a&&(c.anchor=a.source.substring(1));break;case"block-map":case"block-seq":case"flow-collection":c=nn(yi,s,e,t,n),a&&(c.anchor=a.source.substring(1));break;default:{let u=e.type==="error"?e.message:`Unsupported token (type: ${e.type})`;n(e,"UNEXPECTED_TOKEN",u),c=Rt(s,e.offset,void 0,null,t,n),p=!1}}return a&&c.anchor===""&&n(a,"BAD_ALIAS","Anchor cannot be an empty string"),i&&s.options.stringKeys&&(!A(c)||typeof c.value!="string"||c.tag&&c.tag!=="tag:yaml.org,2002:str")&&n(l??e,"NON_STRING_KEY","With stringKeys, all keys must be strings"),o&&(c.spaceBefore=!0),r&&(e.type==="scalar"&&e.source===""?c.comment=r:c.commentBefore=r),s.options.keepSourceTokens&&p&&(c.srcToken=e),c}function Rt(s,e,t,n,{spaceBefore:i,comment:o,anchor:r,tag:a,end:l},c){let p={type:"scalar",offset:rn(e,t,n),indent:-1,source:""},u=ds(s,p,a,c);return r&&(u.anchor=r.source.substring(1),u.anchor===""&&c(r,"BAD_ALIAS","Anchor cannot be an empty string")),i&&(u.spaceBefore=!0),o&&(u.comment=o,u.range[2]=l),u}function bi({options:s},{offset:e,source:t,end:n},i){let o=new te(t.substring(1));o.source===""&&i(e,"BAD_ALIAS","Alias cannot be an empty string"),o.source.endsWith(":")&&i(e+t.length-1,"BAD_ALIAS","Alias ending in : is ambiguous",!0);let r=e+t.length,a=oe(n,r,s.strict,i);return o.range=[e,r,a.offset],a.comment&&(o.comment=a.comment),o}function an(s,e,{offset:t,start:n,value:i,end:o},r){let a=Object.assign({_directives:e},s),l=new ne(void 0,a),c={atKey:!1,atRoot:!0,directives:l.directives,options:l.options,schema:l.schema},p=ie(n,{indicator:"doc-start",next:i??o?.[0],offset:t,onError:r,parentIndent:0,startOnNewline:!0});p.found&&(l.directives.docStart=!0,i&&(i.type==="block-map"||i.type==="block-seq")&&!p.hasNewline&&r(p.end,"MISSING_CHAR","Block collection cannot start on same line with directives-end marker")),l.contents=i?ps(c,i,p,r):Rt(c,p.end,n,null,p,r);let u=l.contents.range[2],f=oe(o,u,!1,r);return f.comment&&(l.comment=f.comment),l.range=[t,u,f.offset],l}function tt(s){if(typeof s=="number")return[s,s+1];if(Array.isArray(s))return s.length===2?s:[s[0],s[1]];let{offset:e,source:t}=s;return[e,e+(typeof t=="string"?t.length:1)]}function ln(s){let e="",t=!1,n=!1;for(let i=0;i<s.length;++i){let o=s[i];switch(o[0]){case"#":e+=(e===""?"":n?`

`:`
`)+(o.substring(1)||" "),t=!0,n=!1;break;case"%":s[i+1]?.[0]!=="#"&&(i+=1),t=!1;break;default:t||(n=!0),t=!1}}return{comment:e,afterEmptyLine:n}}var Se=class{constructor(e={}){this.doc=null,this.atDirectives=!1,this.prelude=[],this.errors=[],this.warnings=[],this.onError=(t,n,i,o)=>{let r=tt(t);o?this.warnings.push(new Pe(r,n,i)):this.errors.push(new q(r,n,i))},this.directives=new ee({version:e.version||"1.2"}),this.options=e}decorate(e,t){let{comment:n,afterEmptyLine:i}=ln(this.prelude);if(n){let o=e.contents;if(t)e.comment=e.comment?`${e.comment}
...
${r}`:n}}t?(Array.prototype.push.apply(e.errors,this.errors),Array.prototype.push.apply(e.warnings,this.warnings)):(e.errors=this.errors,e.warnings=this.warnings),this.prelude=[],this.errors=[],this.warnings=[]}streamInfo(){return{comment:ln(this.prelude).comment,directives:this.directives,errors:this.errors,warnings:this.warnings}}*compose(e,t=!1,n=-1){for(let i of e)yield*this.next(i);yield*this.end(t,n)}*next(e){switch(e.type){case"directive":this.directives.add(e.source,(t,n,i)=>{let o=tt(e);o[0]+=t,this.onError(o,"BAD_DIRECTIVE",n,i)}),this.prelude.push(e.source),this.atDirectives=!0;break;case"document":{let t=an(this.options,this.directives,e,this.onError);this.atDirectives&&!t.directives.docStart&&this.onError(e,"MISSING_CHAR","Missing directives-end/doc-start indicator line"),this.decorate(t,!1),this.doc&&(yield this.doc),this.doc=t,this.atDirectives=!1;break}case"byte-order-mark":case"space":break;case"comment":case"newline":this.prelude.push(e.source);break;case"error":{let t=e.source?`${e.message}: ${JSON.stringify(e.source)}`:e.message,n=new q(tt(e),"UNEXPECTED_TOKEN",t);this.atDirectives||!this.doc?this.errors.push(n):this.doc.errors.push(n);break}case"doc-end":{if(!this.doc){let n="Unexpected doc-end without preceding document";this.errors.push(new q(tt(e),"UNEXPECTED_TOKEN",n));break}this.doc.directives.docEnd=!0;let t=oe(e.end,e.offset+e.source.length,this.doc.options.strict,this.onError);if(this.decorate(this.doc,!0),t.comment){let n=this.doc.comment;this.doc.comment=n?`${n}
${t.comment}`:t.comment}this.doc.range[2]=t.offset;break}default:this.errors.push(new q(tt(e),"UNEXPECTED_TOKEN",`Unsupported token ${e.type}`))}}*end(e=!1,t=-1){if(this.doc)this.decorate(this.doc,!0),yield this.doc,this.doc=null;else if(e){let n=Object.assign({_directives:this.directives},this.options),i=new ne(void 0,n);this.atDirectives&&this.onError(t,"MISSING_CHAR","Missing directives-end indicator line"),i.range=[0,t,t],this.decorate(i,!1),yield i}}};var ys={};Ns(ys,{BOM:()=>st,DOCUMENT:()=>nt,FLOW_END:()=>it,SCALAR:()=>De,createScalarToken:()=>un,isCollection:()=>ki,isScalar:()=>xi,prettyToken:()=>vi,resolveAsScalar:()=>cn,setScalarValue:()=>fn,stringify:()=>pn,tokenType:()=>gs,visit:()=>ye});function cn(s,e=!0,t){if(s){let n=(i,o,r)=>{let a=typeof i=="number"?i:Array.isArray(i)?i[0]:i.offset;if(t)t(a,o,r);else throw new q([a,a+1],o,r)};switch(s.type){case"scalar":case"single-quoted-scalar":case"double-quoted-scalar":return Dt(s,e,n);case"block-scalar":return Pt({options:{strict:e}},s,n)}}return null}function un(s,e){let{implicitKey:t=!1,indent:n,inFlow:i=!1,offset:o=-1,type:r="PLAIN"}=e,a=ce({type:r,value:s},{implicitKey:t,indent:n>0?" ".repeat(n):"",inFlow:i,options:{blockQuote:!0,lineWidth:-1}}),l=e.end??[{type:"newline",offset:-1,indent:n,source:`
`}];switch(a[0]){case"|":case">":{let c=a.indexOf(`
`),p=a.substring(0,c),u=a.substring(c+1)+`
`,f=[{type:"block-scalar-header",offset:o,indent:n,source:p}];return dn(f,l)||f.push({type:"newline",offset:-1,indent:n,source:`
`}),{type:"block-scalar",offset:o,indent:n,props:f,source:u}}case'"':return{type:"double-quoted-scalar",offset:o,indent:n,source:a,end:l};case"'":return{type:"single-quoted-scalar",offset:o,indent:n,source:a,end:l};default:return{type:"scalar",offset:o,indent:n,source:a,end:l}}}function fn(s,e,t={}){let{afterKey:n=!1,implicitKey:i=!1,inFlow:o=!1,type:r}=t,a="indent"in s?s.indent:null;if(n&&typeof a=="number"&&(a+=2),!r)switch(s.type){case"single-quoted-scalar":r="QUOTE_SINGLE";break;case"double-quoted-scalar":r="QUOTE_DOUBLE";break;case"block-scalar":{let c=s.props[0];if(c.type!=="block-scalar-header")throw new Error("Invalid block scalar header");r=c.source[0]===">"?"BLOCK_FOLDED":"BLOCK_LITERAL";break}default:r="PLAIN"}let l=ce({type:r,value:e},{implicitKey:i||a===null,indent:a!==null&&a>0?" ".repeat(a):"",inFlow:o,options:{blockQuote:!0,lineWidth:-1}});switch(l[0]){case"|":case">":wi(s,l);break;case'"':ms(s,l,"double-quoted-scalar");break;case"'":ms(s,l,"single-quoted-scalar");break;default:ms(s,l,"scalar")}}function wi(s,e){let t=e.indexOf(`
`),n=e.substring(0,t),i=e.substring(t+1)+`
`;if(s.type==="block-scalar"){let o=s.props[0];if(o.type!=="block-scalar-header")throw new Error("Invalid block scalar header");o.source=n,s.source=i}else{let{offset:o}=s,r="indent"in s?s.indent:-1,a=[{type:"block-scalar-header",offset:o,indent:r,source:n}];dn(a,"end"in s?s.end:void 0)||a.push({type:"newline",offset:-1,indent:r,source:`
`});for(let l of Object.keys(s))l!=="type"&&l!=="offset"&&delete s[l];Object.assign(s,{type:"block-scalar",indent:r,props:a,source:i})}}function dn(s,e){if(e)for(let t of e)switch(t.type){case"space":case"comment":s.push(t);break;case"newline":return s.push(t),!0}return!1}function ms(s,e,t){switch(s.type){case"scalar":case"double-quoted-scalar":case"single-quoted-scalar":s.type=t,s.source=e;break;case"block-scalar":{let n=s.props.slice(1),i=e.length;s.props[0].type==="block-scalar-header"&&(i-=s.props[0].source.length);for(let o of n)o.offset+=i;delete s.props,Object.assign(s,{type:t,source:e,end:n});break}case"block-map":case"block-seq":{let i={type:"newline",offset:s.offset+e.length,indent:s.indent,source:`
`};delete s.items,Object.assign(s,{type:t,source:e,end:[i]});break}default:{let n="indent"in s?s.indent:-1,i="end"in s&&Array.isArray(s.end)?s.end.filter(o=>o.type==="space"||o.type==="comment"||o.type==="newline"):[];for(let o of Object.keys(s))o!=="type"&&o!=="offset"&&delete s[o];Object.assign(s,{type:t,indent:n,source:e,end:i})}}}var pn=s=>"type"in s?jt(s):Bt(s);function jt(s){switch(s.type){case"block-scalar":{let e="";for(let t of s.props)e+=jt(t);return e+s.source}case"block-map":case"block-seq":{let e="";for(let t of s.items)e+=Bt(t);return e}case"flow-collection":{let e=s.start.source;for(let t of s.items)e+=Bt(t);for(let t of s.end)e+=t.source;return e}case"document":{let e=Bt(s);if(s.end)for(let t of s.end)e+=t.source;return e}default:{let e=s.source;if("end"in s&&s.end)for(let t of s.end)e+=t.source;return e}}}function Bt({start:s,key:e,sep:t,value:n}){let i="";for(let o of s)i+=o.source;if(e&&(i+=jt(e)),t)for(let o of t)i+=o.source;return n&&(i+=jt(n)),i}var hs=Symbol("break visit"),Si=Symbol("skip children"),mn=Symbol("remove item");function ye(s,e){"type"in s&&s.type==="document"&&(s={start:s.start,value:s.value}),hn(Object.freeze([]),s,e)}ye.BREAK=hs;ye.SKIP=Si;ye.REMOVE=mn;ye.itemAtPath=(s,e)=>{let t=s;for(let[n,i]of e){let o=t?.[n];if(o&&"items"in o)t=o.items[i];else return}return t};ye.parentCollection=(s,e)=>{let t=ye.itemAtPath(s,e.slice(0,-1)),n=e[e.length-1][0],i=t?.[n];if(i&&"items"in i)return i;throw new Error("Parent collection not found")};function hn(s,e,t){let n=t(e,s);if(typeof n=="symbol")return n;for(let i of["key","value"]){let o=e[i];if(o&&"items"in o){for(let r=0;r<o.items.length;++r){let a=hn(Object.freeze(s.concat([[i,r]])),o.items[r],t);if(typeof a=="number")r=a-1;else{if(a===hs)return hs;a===mn&&(o.items.splice(r,1),r-=1)}}typeof n=="function"&&i==="key"&&(n=n(e,s))}}return typeof n=="function"?n(e,s):n}var st="\uFEFF",nt="",it="",De="",ki=s=>!!s&&"items"in s,xi=s=>!!s&&(s.type==="scalar"||s.type==="single-quoted-scalar"||s.type==="double-quoted-scalar"||s.type==="block-scalar");function vi(s){switch(s){case st:return"<BOM>";case nt:return"<DOC>";case it:return"<FLOW_END>";case De:return"<SCALAR>";default:return JSON.stringify(s)}}function gs(s){switch(s){case st:return"byte-order-mark";case nt:return"doc-mode";case it:return"flow-error-end";case De:return"scalar";case"---":return"doc-start";case"...":return"doc-end";case"":case`
`:case`\r
...
`:case"\r":case"	":return!0;default:return!1}}var gn=new Set("0123456789ABCDEFabcdef"),_i=new Set("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-#;/?:@&=+$_.!~*'()"),Kt=new Set(",[]{}"),Ai=new Set(` ,[]{}
\r	`),bs=s=>!s||Ai.has(s),Re=class{constructor(){this.atEnd=!1,this.blockScalarIndent=-1,this.blockScalarKeep=!1,this.buffer="",this.flowKey=!1,this.flowLevel=0,this.indentNext=0,this.indentValue=0,this.lineEndPos=null,this.next=null,this.pos=0}*lex(e,t=!1){if(e){if(typeof e!="string")throw TypeError("source is not a string");this.buffer=this.buffer?this.buffer+e:e,this.lineEndPos=null}this.atEnd=!t;let n=this.next??"stream";for(;n&&(t||this.hasChars(1));)n=yield*this.parseNext(n)}atLineEnd(){let e=this.pos,t=this.buffer[e];for(;t===" "||t==="	";)t=this.buffer[++e];return!t||t==="#"||t===`
...
**\u8F6C\u6362\u540E\u7AEF** ${s}
                `,protocolOptions:[],noTemplate:!0}};return JSON.stringify(t)}function Ni(s){let e=s.get("Content-Disposition")||s.get("content-disposition");if(!e)return null;let t=e.match(/filename="?([^"]+)"?/);if(!t)return null;let n=t[1];if(!/[^\x00-\x7F]/.test(n))return e;let o="download.json",r=encodeURIComponent(n);return`attachment; filename="${o}"; filename*=UTF-8''${r}`}async function Vt(){let s=new Set,e=["https://github.com/mnixry/direct-android-ruleset/raw/refs/heads/rules/@Merged/GAME.mutated.yaml","https://github.com/mnixry/direct-android-ruleset/raw/refs/heads/rules/@Merged/APP.mutated.yaml"],t=["\u6D4F\u89C8\u5668"],n=new Set(["com.android.chrome","mark.via"]);for(let i of e){let o=await Q(i);if(!o||o===!0||o.status!==200){console.error(`\u274C \u8BF7\u6C42\u5931\u8D25: ${i}`);continue}let r=typeof o.data=="string"?o.data:JSON.stringify(o.data);for(let a of r.split(`
`)){let l=a.match(/PROCESS-NAME\s*,\s*([^\s,]+)/);if(l){let c=l[1];!t.some(u=>a.includes(u))&&!n.has(c)&&s.add(c)}}}return[...s]}async function Yt(){let s=["https://raw.githubusercontent.com/Kwisma/clash-rules/release/cncidr.yaml"],e=[];for(let t of s){let n=await fetch(t,{headers:{"user-agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.3"}});if(!n.ok){console.error(`\u274C \u8BF7\u6C42\u5931\u8D25: ${t} - ${n.status} ${n.statusText}`);continue}let i=await n.text(),o=ks.parse(i,{maxAliasCount:-1,merge:!0});Array.isArray(o.payload)&&e.push(...o.payload)}return e}async function vs(s){return s.urls.length===1?await Li(s):await Oi(s)}async function Li(s){let e=await Dn(s.urls[0],s.userAgent,s.sub);return e?.data?.proxies&&Array.isArray(e.data.proxies)&&e.data.proxies.length>0?(Rn(e.data.proxies,s.udp),Ei(e,{providers:{}})):null}async function Oi(s){let e={proxies:[],providers:{}},t=[];for(let o=0;o<s.urls.length;o++){let r=await Dn(s.urls[o],s.userAgent,s.sub);r?.data?.proxies&&Array.isArray(r.data.proxies)&&(Rn(r.data.proxies,s.udp,o+1),t.push({status:r.status,headers:r.headers}),e.proxies.push(...r.data.proxies))}if(t.length===0)return null;let n=Math.floor(Math.random()*t.length),i=t[n];return{status:i.status,headers:i.headers,data:e}}async function Dn(s,e,t){let n=await Q(s,e,!1);if(n?.data?.proxies&&Array.isArray(n.data.proxies)&&n.data.proxies.length>0)return n;let i=Ke(s,t,"clash.meta");return await Q(i,e,!1)}function Rn(s,e,t=null){s.forEach(n=>{t!==null&&(n.name=`${n.name} [${t}]`),e&&(n.udp=!0)})}function Ei(s,e={}){return{status:s.status,headers:s.headers,data:{...s.data,...e}}}async function Bn(s){if(!/meta|clash.meta|clash|clashverge|mihomo/i.test(s.userAgent))throw new Error("\u4E0D\u652F\u6301\u7684\u5BA2\u6237\u7AEF");s.urls=Ft(s.urls);let[e,t,n,i,o]=await Promise.all([Ut(s.Mihomo_default),Gt(s.rule),vs(s),s.exclude_package?Vt():null,s.exclude_address?Yt():null]);if(s.Exclude_Package=i,s.Exclude_Address=o,!n?.data?.proxies||n?.data?.proxies?.length===0)throw new Error("\u8282\u70B9\u4E3A\u7A7A");return t.data.proxies=[...t?.data?.proxies||[],...n?.data?.proxies],t.data["proxy-groups"]=Ii(n.data,t.data),t.data["proxy-providers"]=n?.data?.providers,Ci(e.data,t.data,s),{status:n.status,headers:n.headers,data:JSON.stringify(e.data,null,4)}}function Ci(s,e,t){s["proxy-providers"]=e["proxy-providers"]||{},s.proxies=e.proxies||[],s["proxy-groups"]=e["proxy-groups"]||[],s.rules=e.rules||[],s["sub-rules"]=e["sub-rules"]||{},s["rule-providers"]={...s["rule-providers"]||{},...e["rule-providers"]||{}},t.tun&&s.tun?s.tun.enable=!1:s.tun&&(t.exclude_address&&t.Exclude_Address&&(s.tun["route-address"]=["0.0.0.0/1","128.0.0.0/1","::/1","8000::/1"],s.tun["route-exclude-address"]=t.Exclude_Address||[]),t.exclude_package&&t.Exclude_Package&&(s.tun["include-package"]=[],s.tun["exclude-package"]=t.Exclude_Package||[])),t.adgdns&&(s.dns.nameserver=["https://dns.adguard-dns.com/dns-query"],s.dns["nameserver-policy"]["RULE-SET:private_domain,cn_domain"]=["quic://dns.18bit.cn"])}function Ii(s,e){let t=[],n=e["proxy-groups"].filter(i=>{let o=!1,r=i.filter;if(typeof r!="string")return!0;let a=/\(\?i\)/i.test(r),l=r.replace(/\(\?i\)/gi,""),c;try{c=new RegExp(l,a?"i":"")}catch(p){return console.warn(`\u65E0\u6548\u7684\u6B63\u5219\u8868\u8FBE\u5F0F: ${r}`,p),!0}for(let p of s.proxies)if(c.test(p.name)){o=!0;break}return!o&&(!i.proxies||i.proxies.length===0)?(t.push(i.name),!1):!0});return n.forEach(i=>{i.proxies&&(i.proxies=i.proxies.filter(o=>!t.some(r=>r.includes(o))))}),n}async function _s(s){return s.urls.length===1?await Ti(s.urls[0],s):await Mi(s)}async function Ti(s,e){let t=await Kn(s,e,!1);return t?.data?.outbounds?.length>0?(qn(t.data.outbounds,e,0),$i(t)):null}async function Mi(s){let e=[],t=[];for(let i=0;i<s.urls.length;i++){let o=await Kn(s.urls[i],s,!0,i+1);o?.data?.outbounds?.length>0&&(qn(o.data.outbounds,s,i+1),t.push(o),e.push(o.data.outbounds))}if(t.length===0)throw new Error("No valid outbounds found from any URL");let n=t[Math.floor(Math.random()*t.length)];return{status:n.status,headers:n.headers,data:{outbounds:e.flat()}}}async function Kn(s,e,t,n=null){let i=await Q(s,e.userAgent,!1);if(jn(i))return i;let o=Ke(s,e.sub,"singbox");return i=await Q(o,e.userAgent,!1),jn(i)?i:null}function jn(s){return s?.data?.outbounds&&Array.isArray(s.data.outbounds)}function qn(s,e,t){s.forEach(n=>{t>0&&(n.tag=`${n.tag} [${t}]`),e.udp_fragment&&(n.udp_fragment=!0)})}function $i(s){return{status:s.status,headers:s.headers,data:s.data}}async function Fn(s){let e=Pi(s);s.urls=Ft(s.urls);let[t,n,i,o,r]=await Promise.all([Ut(e),Gt(s.rule),_s(s),s.exclude_package?Vt():null,s.exclude_address?Yt():null]);if(s.Exclude_Package=o,s.Exclude_Address=r,!i?.data?.outbounds||i?.data?.outbounds?.length===0)throw new Error("\u8282\u70B9\u4E3A\u7A7A\uFF0C\u8BF7\u4F7F\u7528\u6709\u6548\u8BA2\u9605");i.data.outbounds=Di(i.data);let a=[];return i.data.outbounds.forEach(l=>{a.push(l.tag)}),n.data.outbounds=Ri(n.data.outbounds,a),n.data.outbounds.push(...i.data.outbounds),Bi(t.data,n.data,s),{status:i.status,headers:i.headers,data:JSON.stringify(t.data,null,4)}}function Pi(s){let e,t=!1,n=s.userAgent.match(/1\.12\.0\-alpha\.(\d{1,2})\b/),i=s.userAgent.match(/1\.12\.0\-beta\.(\d{1,2})\b/),o=s.userAgent.match(/1\.11\.(\d+)/),r=s.userAgent.match(/1\.12\.(\d+)/),a=s.userAgent.match(/1\.13\.(\d+)/),l=s.userAgent.match(/1\.14\.(\d+)/);if(!/singbox|sing-box|sfa|sfm/i.test(s.userAgent))throw new Error("\u4E0D\u652F\u6301\u7684\u5BA2\u6237\u7AEF");if(n&&!t){let c=parseInt(n[1],10);c>=0&&c<=23&&(e=s.singbox_1_12_alpha,t=!0)}if(i&&!t){let c=parseInt(i[1],10);c>=0&&c<=9&&(e=s.singbox_1_11,s.tailscale=!1,s.tls_fragment=!1,t=!0)}if(o&&!t&&(e=s.singbox_1_11,s.tailscale=!1,s.tls_fragment=!1,t=!0),r&&!t&&(e=s.singbox_1_12,t=!0),a&&!t&&(e=s.singbox_1_13,t=!0),l&&!t&&(e=s.singbox_1_14,t=!0),!t)throw new Error(`\u4E0D\u652F\u6301\u7684 Singbox \u7248\u672C\uFF1A${s.userAgent}`);return e}function Di(s){let e=["direct","block","dns","selector","urltest"];if(s&&Array.isArray(s.outbounds))return s.outbounds.filter(n=>!(e.includes(n.type)||n?.server===""||n?.server_port<1||n?.password===""))}function Ri(s,e){let t=l=>{let c=[],p=!1;return l.filter?.forEach(u=>{if(u.action!=="all"&&(!u.keywords||typeof u.keywords!="string"))return;let f=[];if(u.action==="all")f=e,p=!0;else{let{pattern:h,ignoreCase:g}=n(u.keywords),d=new RegExp(h,g?"i":"");f=i(e,d,u.action),p=!0}f.length>0&&(c=[...c,...f])}),{matchedOutbounds:[...new Set(c)],hasValidAction:p}},n=l=>{if(!l||typeof l!="string")return{pattern:"^$",ignoreCase:!1};let c=/\(\?i\)/i.test(l);return{pattern:l.replace(/\(\?i\)/gi,""),ignoreCase:c}},i=(l,c,p)=>{switch(p){case"include":return l.filter(u=>c.test(u));case"exclude":return l.filter(u=>!c.test(u));default:return[]}},o=(l,c,p)=>(c.length>0?l.outbounds=l.outbounds?[...new Set([...l.outbounds,...c])]:c:l.outbounds&&l.outbounds.length>0||delete l.outbounds,delete l.filter,l),r=l=>{let c=l.filter(u=>!u.outbounds||Array.isArray(u.outbounds)&&u.outbounds.length===0).map(u=>u.tag).filter(u=>u!==void 0);return l.map(u=>(u.outbounds&&Array.isArray(u.outbounds)&&(u.outbounds=u.outbounds.filter(f=>!c.includes(f))),u)).filter(u=>u.outbounds&&Array.isArray(u.outbounds)&&u.outbounds.length>0)},a=s.map(l=>{let{matchedOutbounds:c,hasValidAction:p}=t(l);return o(l,c,p)});return r(a)}function Bi(s,e,t){let n=Array.isArray(s.route.rule_set)?s.route.rule_set:[],i=Array.isArray(e.route.rule_set)?e.route.rule_set:[],o=new Map;for(let r of n)r?.tag&&o.set(r.tag,r);for(let r of i)r?.tag&&o.set(r.tag,r);if(s.inbounds=e?.inbounds||s.inbounds,s.outbounds=[...Array.isArray(s.outbounds)?s.outbounds:[],...Array.isArray(e?.outbounds)?e.outbounds:[]],s.route.final=e?.route?.final||s.route.final,s.route.rules=[...Array.isArray(s.route.rules)?s.route.rules:[],...Array.isArray(e?.route?.rules)?e.route.rules:[]],s.route.rule_set=Array.from(o.values()),t.tun?s.inbounds=s.inbounds.filter(r=>r.type!=="tun"):(t.exclude_package&&ji(s,t.Exclude_Package),t.exclude_address&&Ki(s,t.Exclude_Address)),t.tailscale&&(s.dns.servers.push({type:"tailscale",endpoint:"ts-ep",accept_default_resolvers:!0}),s.endpoints=s.endpoints||[],s.endpoints.push({type:"tailscale",tag:"ts-ep",auth_key:"",hostname:"singbox-tailscale",udp_timeout:"5m"})),/ref1nd/i.test(t.userAgent))for(let r of s.route.rules)r.action==="resolve"&&(r.match_only=!0);s.route.rules=s.route.rules.flatMap(r=>r.action==="route-options"?(t.udp&&(r.udp_disable_domain_unmapping=!0,r.udp_connect=!0,r.udp_timeout="5m"),t.tls_fragment&&(r.tls_fragment=!0,r.tls_fragment_fallback_delay="5m"),t.udp||t.tls_fragment?r:[]):r),t.adgdns&&s.dns.servers.flatMap(r=>(r.tag==="DIRECT-DNS"&&(r={type:"quic",tag:"DIRECT-DNS",detour:"\u{1F3AF} \u5168\u7403\u76F4\u8FDE",server_port:853,server:"dns.18bit.cn",domain_resolver:"local"}),r.tag==="PROXY-DNS"&&(r={type:"https",tag:"PROXY-DNS",detour:"\u{1F680} \u8282\u70B9\u9009\u62E9",server_port:443,server:"dns.adguard-dns.com",domain_resolver:"local"}),r))}function ji(s,e){for(let t of s.inbounds)t.type==="tun"&&(Array.isArray(t.exclude_package)||(t.exclude_package=[]),t.exclude_package=Array.from(new Set([...t.exclude_package||[],...e])))}function Ki(s,e){for(let t of s.inbounds)t.type==="tun"&&(t.route_address=["0.0.0.0/1","128.0.0.0/1","::/1","8000::/1"],Array.isArray(t.route_exclude_address)||(t.route_exclude_address=[]),t.route_exclude_address=Array.from(new Set([...t.route_exclude_address||[],...e])))}async function Un(s){let e=Ke(s.urls.join(","),s.sub,"v2ray"),t=await Q(e,s.userAgent);if(t.data!==void 0&&t.data!==null&&t.data!=="")return{status:t.status,headers:t.headers,data:t.data};throw new Error("\u83B7\u53D6\u8BA2\u9605\u6570\u636E\u5931\u8D25\uFF0C\u8BF7\u68C0\u67E5\u8BA2\u9605\u94FE\u63A5\u662F\u5426\u6709\u6548")}var qi=s=>`
        :root {
...
`,Gn=qi;async function Vn(s){return`
<!DOCTYPE html>
<html>
...
</html>`}async function Fi(s,e){let t=new URL(s.url,`http://${s.headers.host}`),n={url:t,urls:t.searchParams.getAll("url"),userAgent:s.headers["user-agent"],rule:t.searchParams.get("template"),singbox:t.searchParams.get("singbox")==="true",mihomo:t.searchParams.get("mihomo")==="true",v2ray:t.searchParams.get("v2ray")==="true",udp:t.searchParams.get("udp")==="true",udp_fragment:t.searchParams.get("udp_frag")==="true",tls_fragment:t.searchParams.get("tls_frag")==="true",exclude_package:t.searchParams.get("ep")==="true",exclude_address:t.searchParams.get("ea")==="true",tailscale:t.searchParams.get("tailscale")==="true",adgdns:t.searchParams.get("adgdns")==="true",tun:t.searchParams.get("tun")==="true",IMG:process.env.IMG||_n,sub:process.env.SUB||An,Mihomo_default:process.env.MIHOMOTOP||Nn,singbox_1_11:process.env.SINGBOX_1_11||Ln,singbox_1_12:process.env.SINGBOX_1_12||On,singbox_1_12_alpha:process.env.SINGBOX_1_12_ALPHA||En,singbox_1_13:process.env.SINGBOX_1_13||Cn,singbox_1_14:process.env.SINGBOX_1_14||In,beian:process.env.BEIAN||Tn,beianurl:process.env.BEIANURL||Mn,configs:$n(process.env.MIHOMO,process.env.SINGBOX)};if(n.modes=Pn(n.sub,n.userAgent),n.urls.length===1&&n.urls[0].includes(",")&&(n.urls=n.urls[0].split(",").map(i=>i.trim())),n.urls.length===0||n.urls[0]===""){let i=await Vn(n);e.setHeader("Content-Type","text/html; charset=utf-8"),e.statusCode=200,e.end(i);return}try{let i;n.singbox?i=await Fn(n):n.mihomo?i=await Bn(n):n.v2ray&&(i=await Un(n));let o=i.headers,r=["transfer-encoding","content-length","content-encoding","connection"];for(let[a,l]of Object.entries(o))r.includes(a.toLowerCase())||e.setHeader(a,l);e.setHeader("Content-Type","application/json; charset=utf-8"),e.setHeader("Profile-web-page-url",t.origin),e.statusCode=i.status||200,e.end(i.data)}catch(i){e.statusCode=400,e.setHeader("Content-Type","application/json; charset=utf-8"),e.end(JSON.stringify({error:i.message}))}}export{Fi as default};
