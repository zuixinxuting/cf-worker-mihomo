...
${t.indent}`)}}else(v===""||v[0]===`
`)&&(A="");return m+=A+v,t.inFlow?x&&n&&n():k&&!x?m+=te(m,t.indent,c(k)):d&&i&&i(),m}function gt(s,e){(s==="debug"||s==="warn")&&console.warn(e)}var yt="<<",H={identify:s=>s===yt||typeof s=="symbol"&&s.description===yt,default:"key",tag:"tag:yaml.org,2002:merge",test:/^<<$/,resolve:()=>Object.assign(new y(Symbol(yt)),{addToJSMap:es}),stringify:()=>yt},$s=(s,e)=>(H.identify(e)||_(e)&&(!e.type||e.type===y.PLAIN)&&H.identify(e.value))&&s?.doc.schema.tags.some(t=>t.tag===H.tag&&t.default);function es(s,e,t){if(t=s&&K(t)?t.resolve(s.doc):t,G(t))for(let n of t.items)Zt(s,e,n);else if(Array.isArray(t))for(let n of t)Zt(s,e,n);else Zt(s,e,t)}function Zt(s,e,t){let n=s&&K(t)?t.resolve(s.doc):t;if(!U(n))throw new Error("Merge sources must be maps or map aliases");let i=n.toJSON(null,s,Map);for(let[r,o]of i)e instanceof Map?e.has(r)||e.set(r,o):e instanceof Set?e.add(r):Object.prototype.hasOwnProperty.call(e,r)||Object.defineProperty(e,r,{value:o,writable:!0,enumerable:!0,configurable:!0});return e}function bt(s,e,{key:t,value:n}){if(L(t)&&t.addToJSMap)t.addToJSMap(s,e,n);else if($s(s,t))es(s,e,n);else{let i=$(t,"",s);if(e instanceof Map)e.set(i,$(n,i,s));else if(e instanceof Set)e.add(i);else{let r=ei(t,i,s),o=$(n,r,s);r in e?Object.defineProperty(e,r,{value:o,writable:!0,enumerable:!0,configurable:!0}):e[r]=o}}return e}function ei(s,e,t){if(e===null)return"";if(typeof e!="object")return String(e);if(L(s)&&t?.doc){let n=ht(t.doc,{});n.anchors=new Set;for(let r of t.anchors.keys())n.anchors.add(r.anchor);n.inFlow=!0,n.inStringifyKey=!0;let i=s.toString(n);if(!t.mapKeyWarned){let r=JSON.stringify(i);r.length>40&&(r=r.substring(0,36)+'..."'),gt(t.doc.options.logLevel,`Keys with collection values will be stringified due to JS Object restrictions: ${r}. Set mapAsMap: true to use object keys.`),t.mapKeyWarned=!0}return i}return JSON.stringify(e)}function Ee(s,e,t){let n=le(s,void 0,t),i=le(e,void 0,t);return new C(n,i)}var C=class s{constructor(e,t=null){Object.defineProperty(this,R,{value:Jt}),this.key=e,this.value=t}clone(e){let{key:t,value:n}=this;return L(t)&&(t=t.clone(e)),L(n)&&(n=n.clone(e)),new s(t,n)}toJSON(e,t){let n=t?.mapAsMap?new Map:{};return bt(t,n,this)}toString(e,t,n){return e?.doc?Ms(this,e,t,n):JSON.stringify(this)}};function St(s,e,t){return(e.inFlow??s.flow?si:ti)(s,e,t)}function ti({comment:s,items:e},t,{blockItemPrefix:n,flowChars:i,itemIndent:r,onChompKeep:o,onComment:a}){let{indent:l,options:{commentString:c}}=t,p=Object.assign({},t,{indent:r,type:null}),u=!1,f=[];for(let g=0;g<e.length;++g){let d=e[g],m=null;if(L(d))!u&&d.spaceBefore&&f.push(""),wt(t,f,d.commentBefore,u),d.comment&&(m=d.comment);else if(N(d)){let S=L(d.key)?d.key:null;S&&(!u&&S.spaceBefore&&f.push(""),wt(t,f,S.commentBefore,u))}u=!1;let w=ue(d,p,()=>m=null,()=>u=!0);m&&(w+=te(w,r,c(m))),u&&m&&(u=!1),f.push(n+w)}let h;if(f.length===0)h=i.start+i.end;else{h=f[0];for(let g=1;g<f.length;++g){let d=f[g];h+=d?`
${l}${d}`:`
`}}return s?(h+=`
...
${t.comment}`:t.comment}this.doc.range[2]=t.offset;break}default:this.errors.push(new q(tt(e),"UNEXPECTED_TOKEN",`Unsupported token ${e.type}`))}}*end(e=!1,t=-1){if(this.doc)this.decorate(this.doc,!0),yield this.doc,this.doc=null;else if(e){let n=Object.assign({_directives:this.directives},this.options),i=new se(void 0,n);this.atDirectives&&this.onError(t,"MISSING_CHAR","Missing directives-end indicator line"),i.range=[0,t,t],this.decorate(i,!1),yield i}}};var ys={};_s(ys,{BOM:()=>st,DOCUMENT:()=>nt,FLOW_END:()=>it,SCALAR:()=>De,createScalarToken:()=>cn,isCollection:()=>Si,isScalar:()=>ki,prettyToken:()=>xi,resolveAsScalar:()=>ln,setScalarValue:()=>un,stringify:()=>dn,tokenType:()=>gs,visit:()=>ye});function ln(s,e=!0,t){if(s){let n=(i,r,o)=>{let a=typeof i=="number"?i:Array.isArray(i)?i[0]:i.offset;if(t)t(a,r,o);else throw new q([a,a+1],r,o)};switch(s.type){case"scalar":case"single-quoted-scalar":case"double-quoted-scalar":return Dt(s,e,n);case"block-scalar":return Pt({options:{strict:e}},s,n)}}return null}function cn(s,e){let{implicitKey:t=!1,indent:n,inFlow:i=!1,offset:r=-1,type:o="PLAIN"}=e,a=ce({type:o,value:s},{implicitKey:t,indent:n>0?" ".repeat(n):"",inFlow:i,options:{blockQuote:!0,lineWidth:-1}}),l=e.end??[{type:"newline",offset:-1,indent:n,source:`
...
`:case"\r":case"	":return!0;default:return!1}}var hn=new Set("0123456789ABCDEFabcdef"),vi=new Set("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-#;/?:@&=+$_.!~*'()"),Kt=new Set(",[]{}"),Ai=new Set(` ,[]{}
